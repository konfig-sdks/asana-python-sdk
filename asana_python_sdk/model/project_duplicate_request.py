    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class include(
                ...
                class MetaOapg:
                    regex=[{
                        'pattern': r'([allocations|members|notes|forms|task_notes|task_assignee|task_subtasks|task_attachments|task_dates|task_dependencies|task_followers|task_tags|task_projects])(,\1)*',
                    }]
