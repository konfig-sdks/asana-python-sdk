...
class ProjectRequest(
    ...
    class MetaOapg:
        ...
        class all_of_1(
            ...
            def __getitem__(self, name: typing.Union[typing_extensions.Literal["custom_fields", "followers", "owner", "team", "workspace", ], str]):
                # dict_instance[name] accessor
                return super().__getitem__(name)
            ...
            def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["custom_fields", "followers", "owner", "team", "workspace", ], str]):
                return super().get_item_oapg(name)
