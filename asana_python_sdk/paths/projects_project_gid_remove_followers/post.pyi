...
from asana_python_sdk.model.projects_remove_project_followers_request import ProjectsRemoveProjectFollowersRequest as ProjectsRemoveProjectFollowersRequestSchema
from asana_python_sdk.model.remove_followers_request import RemoveFollowersRequest as RemoveFollowersRequestSchema
from asana_python_sdk.model.projects_remove_project_followers_response import ProjectsRemoveProjectFollowersResponse as ProjectsRemoveProjectFollowersResponseSchema
from asana_python_sdk.model.error_response import ErrorResponse as ErrorResponseSchema

from asana_python_sdk.type.remove_followers_request import RemoveFollowersRequest
from asana_python_sdk.type.error_response import ErrorResponse
from asana_python_sdk.type.projects_remove_project_followers_response import ProjectsRemoveProjectFollowersResponse
from asana_python_sdk.type.projects_remove_project_followers_request import ProjectsRemoveProjectFollowersRequest

from ...api_client import Dictionary
from asana_python_sdk.pydantic.error_response import ErrorResponse as ErrorResponsePydantic
from asana_python_sdk.pydantic.projects_remove_project_followers_request import ProjectsRemoveProjectFollowersRequest as ProjectsRemoveProjectFollowersRequestPydantic
from asana_python_sdk.pydantic.remove_followers_request import RemoveFollowersRequest as RemoveFollowersRequestPydantic
from asana_python_sdk.pydantic.projects_remove_project_followers_response import ProjectsRemoveProjectFollowersResponse as ProjectsRemoveProjectFollowersResponsePydantic
...
# body param
SchemaForRequestBodyApplicationJson = ProjectsRemoveProjectFollowersRequestSchema


request_body_projects_remove_project_followers_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ProjectsRemoveProjectFollowersResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ProjectsRemoveProjectFollowersResponse
...
class BaseApi(api_client.Api):
    ...
    def _remove_project_followers_mapped_args(
        self,
        project_gid: str,
        data: typing.Optional[RemoveFollowersRequest] = None,
    ...
    async def _aremove_project_followers_oapg(
        self,
        ...
        **kwargs,
        ...
        serialized_data = request_body_projects_remove_project_followers_request.serialize(body, content_type)
    ...
    def _remove_project_followers_oapg(
        self,
        body: typing.Any = None,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
...
class RemoveProjectFollowersRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aremove_project_followers(
        self,
        project_gid: str,
        data: typing.Optional[RemoveFollowersRequest] = None,
        opt_pretty: typing.Optional[bool] = None,
        ...
        **kwargs,
        ...
        args = self._remove_project_followers_mapped_args(
            project_gid=project_gid,
            data=data,
            opt_pretty=opt_pretty,
            opt_fields=opt_fields,
        )
        return await self._aremove_project_followers_oapg(
            body=args.body,
    ...
    def remove_project_followers(
        ...
        return self._remove_project_followers_oapg(
            body=args.body,
            query_params=args.query,
            path_params=args.path,
        )

class RemoveProjectFollowers(BaseApi):
    ...
    async def aremove_project_followers(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ProjectsRemoveProjectFollowersResponsePydantic:
        raw_response = await self.raw.aremove_project_followers(
            project_gid=project_gid,
            data=data,
            opt_pretty=opt_pretty,
            opt_fields=opt_fields,
        ...
        if validate:
            return ProjectsRemoveProjectFollowersResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(ProjectsRemoveProjectFollowersResponsePydantic, raw_response.body)
    ...
    def remove_project_followers(
        ...
        raw_response = self.raw.remove_project_followers(
            project_gid=project_gid,
            data=data,
            opt_pretty=opt_pretty,
            opt_fields=opt_fields,
