...
from asana_python_sdk.model.task_templates_list_multiple_response import TaskTemplatesListMultipleResponse as TaskTemplatesListMultipleResponseSchema
from asana_python_sdk.model.error_response import ErrorResponse as ErrorResponseSchema

from asana_python_sdk.type.task_templates_list_multiple_response import TaskTemplatesListMultipleResponse
...
from asana_python_sdk.pydantic.task_templates_list_multiple_response import TaskTemplatesListMultipleResponse as TaskTemplatesListMultipleResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = TaskTemplatesListMultipleResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: TaskTemplatesListMultipleResponse
...
class ListMultiple(BaseApi):
    ...
    async def alist_multiple(
        ...
        validate: bool = False,
        **kwargs,
    ) -> TaskTemplatesListMultipleResponsePydantic:
        ...
        if validate:
            return TaskTemplatesListMultipleResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(TaskTemplatesListMultipleResponsePydantic, raw_response.body)
