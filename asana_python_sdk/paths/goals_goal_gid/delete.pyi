...
from asana_python_sdk.model.goals_delete_record_response import GoalsDeleteRecordResponse as GoalsDeleteRecordResponseSchema
from asana_python_sdk.model.error_response import ErrorResponse as ErrorResponseSchema

from asana_python_sdk.type.goals_delete_record_response import GoalsDeleteRecordResponse
...
from asana_python_sdk.pydantic.goals_delete_record_response import GoalsDeleteRecordResponse as GoalsDeleteRecordResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = GoalsDeleteRecordResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: GoalsDeleteRecordResponse
...
class DeleteRecord(BaseApi):
    ...
    async def adelete_record(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GoalsDeleteRecordResponsePydantic:
        ...
        if validate:
            return GoalsDeleteRecordResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(GoalsDeleteRecordResponsePydantic, raw_response.body)
