...
from asana_python_sdk.model.goal_update_request import GoalUpdateRequest as GoalUpdateRequestSchema
from asana_python_sdk.model.goals_update_goal_record_response import GoalsUpdateGoalRecordResponse as GoalsUpdateGoalRecordResponseSchema
from asana_python_sdk.model.goals_update_goal_record_request import GoalsUpdateGoalRecordRequest as GoalsUpdateGoalRecordRequestSchema
from asana_python_sdk.model.error_response import ErrorResponse as ErrorResponseSchema

from asana_python_sdk.type.goals_update_goal_record_request import GoalsUpdateGoalRecordRequest
from asana_python_sdk.type.goal_update_request import GoalUpdateRequest
from asana_python_sdk.type.goals_update_goal_record_response import GoalsUpdateGoalRecordResponse
...
from asana_python_sdk.pydantic.goals_update_goal_record_request import GoalsUpdateGoalRecordRequest as GoalsUpdateGoalRecordRequestPydantic
from asana_python_sdk.pydantic.goals_update_goal_record_response import GoalsUpdateGoalRecordResponse as GoalsUpdateGoalRecordResponsePydantic
from asana_python_sdk.pydantic.goal_update_request import GoalUpdateRequest as GoalUpdateRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = GoalsUpdateGoalRecordRequestSchema


request_body_goals_update_goal_record_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = GoalsUpdateGoalRecordResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: GoalsUpdateGoalRecordResponse
...
class BaseApi(api_client.Api):
    ...
    def _update_goal_record_mapped_args(
        self,
        goal_gid: str,
        data: typing.Optional[GoalUpdateRequest] = None,
    ...
    async def _aupdate_goal_record_oapg(
        self,
        ...
        **kwargs,
        ...
        serialized_data = request_body_goals_update_goal_record_request.serialize(body, content_type)
...
class UpdateGoalRecordRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_goal_record(
        self,
        goal_gid: str,
        data: typing.Optional[GoalUpdateRequest] = None,
        opt_pretty: typing.Optional[bool] = None,
        ...
        **kwargs,
        ...
        args = self._update_goal_record_mapped_args(
            goal_gid=goal_gid,
            data=data,
            opt_pretty=opt_pretty,
            opt_fields=opt_fields,
        )
        return await self._aupdate_goal_record_oapg(
            body=args.body,
    ...
    def update_goal_record(
        ...
        return self._update_goal_record_oapg(
            body=args.body,
            query_params=args.query,
            path_params=args.path,
        )

class UpdateGoalRecord(BaseApi):
    ...
    async def aupdate_goal_record(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GoalsUpdateGoalRecordResponsePydantic:
        raw_response = await self.raw.aupdate_goal_record(
            goal_gid=goal_gid,
            data=data,
            opt_pretty=opt_pretty,
            opt_fields=opt_fields,
        ...
        if validate:
            return GoalsUpdateGoalRecordResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(GoalsUpdateGoalRecordResponsePydantic, raw_response.body)
    ...
    def update_goal_record(
        ...
        raw_response = self.raw.update_goal_record(
            goal_gid=goal_gid,
            data=data,
            opt_pretty=opt_pretty,
            opt_fields=opt_fields,
