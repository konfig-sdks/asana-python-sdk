...
from asana_python_sdk.model.portfolio_memberships_get_compact_response import PortfolioMembershipsGetCompactResponse as PortfolioMembershipsGetCompactResponseSchema
from asana_python_sdk.model.error_response import ErrorResponse as ErrorResponseSchema

from asana_python_sdk.type.portfolio_memberships_get_compact_response import PortfolioMembershipsGetCompactResponse
from asana_python_sdk.type.error_response import ErrorResponse

from ...api_client import Dictionary
from asana_python_sdk.pydantic.portfolio_memberships_get_compact_response import PortfolioMembershipsGetCompactResponse as PortfolioMembershipsGetCompactResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = PortfolioMembershipsGetCompactResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: PortfolioMembershipsGetCompactResponse
...
class GetCompactRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_compact(
        self,
        portfolio_gid: str,
        user: typing.Optional[str] = None,
        opt_pretty: typing.Optional[bool] = None,
        ...
        **kwargs,
        ...
        args = self._get_compact_mapped_args(
        ...
        return await self._aget_compact_oapg(
    ...
    def get_compact(
        ...
        return self._get_compact_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetCompact(BaseApi):
    ...
    async def aget_compact(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PortfolioMembershipsGetCompactResponsePydantic:
        raw_response = await self.raw.aget_compact(
            portfolio_gid=portfolio_gid,
            user=user,
            opt_pretty=opt_pretty,
            limit=limit,
        ...
        if validate:
            return PortfolioMembershipsGetCompactResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(PortfolioMembershipsGetCompactResponsePydantic, raw_response.body)
    ...
    def get_compact(
        ...
        raw_response = self.raw.get_compact(
            portfolio_gid=portfolio_gid,
            user=user,
            opt_pretty=opt_pretty,
            limit=limit,
