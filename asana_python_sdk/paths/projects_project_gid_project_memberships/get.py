...
from asana_python_sdk.model.project_memberships_get_compact_records_response import ProjectMembershipsGetCompactRecordsResponse as ProjectMembershipsGetCompactRecordsResponseSchema
from asana_python_sdk.model.error_response import ErrorResponse as ErrorResponseSchema

from asana_python_sdk.type.project_memberships_get_compact_records_response import ProjectMembershipsGetCompactRecordsResponse
...
from asana_python_sdk.pydantic.project_memberships_get_compact_records_response import ProjectMembershipsGetCompactRecordsResponse as ProjectMembershipsGetCompactRecordsResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = ProjectMembershipsGetCompactRecordsResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ProjectMembershipsGetCompactRecordsResponse
...
class GetCompactRecords(BaseApi):
    ...
    async def aget_compact_records(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ProjectMembershipsGetCompactRecordsResponsePydantic:
        ...
        if validate:
            return ProjectMembershipsGetCompactRecordsResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(ProjectMembershipsGetCompactRecordsResponsePydantic, raw_response.body)
