...
from asana_python_sdk.model.projects_delete_project_by_id_response import ProjectsDeleteProjectByIdResponse as ProjectsDeleteProjectByIdResponseSchema
from asana_python_sdk.model.error_response import ErrorResponse as ErrorResponseSchema

from asana_python_sdk.type.projects_delete_project_by_id_response import ProjectsDeleteProjectByIdResponse
...
from asana_python_sdk.pydantic.projects_delete_project_by_id_response import ProjectsDeleteProjectByIdResponse as ProjectsDeleteProjectByIdResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = ProjectsDeleteProjectByIdResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ProjectsDeleteProjectByIdResponse
...
class BaseApi(api_client.Api):
    ...
    def _delete_project_by_id_mapped_args(
        self,
        project_gid: str,
    ...
    async def _adelete_project_by_id_oapg(
        self,
    ...
    def _delete_project_by_id_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class DeleteProjectByIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_project_by_id(
        self,
        project_gid: str,
        opt_pretty: typing.Optional[bool] = None,
        **kwargs,
        ...
        args = self._delete_project_by_id_mapped_args(
            project_gid=project_gid,
            opt_pretty=opt_pretty,
        )
        return await self._adelete_project_by_id_oapg(
    ...
    def delete_project_by_id(
        ...
        return self._delete_project_by_id_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class DeleteProjectById(BaseApi):
    ...
    async def adelete_project_by_id(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ProjectsDeleteProjectByIdResponsePydantic:
        raw_response = await self.raw.adelete_project_by_id(
            project_gid=project_gid,
            opt_pretty=opt_pretty,
            **kwargs,
        )
        if validate:
            return ProjectsDeleteProjectByIdResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(ProjectsDeleteProjectByIdResponsePydantic, raw_response.body)
    ...
    def delete_project_by_id(
        ...
        raw_response = self.raw.delete_project_by_id(
            project_gid=project_gid,
            opt_pretty=opt_pretty,
        )
        if validate:
