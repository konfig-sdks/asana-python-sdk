...
from asana_python_sdk.model.project_update_request import ProjectUpdateRequest as ProjectUpdateRequestSchema
from asana_python_sdk.model.projects_update_project_record_request import ProjectsUpdateProjectRecordRequest as ProjectsUpdateProjectRecordRequestSchema
from asana_python_sdk.model.projects_update_project_record_response import ProjectsUpdateProjectRecordResponse as ProjectsUpdateProjectRecordResponseSchema
from asana_python_sdk.model.error_response import ErrorResponse as ErrorResponseSchema

from asana_python_sdk.type.projects_update_project_record_request import ProjectsUpdateProjectRecordRequest
from asana_python_sdk.type.projects_update_project_record_response import ProjectsUpdateProjectRecordResponse
from asana_python_sdk.type.error_response import ErrorResponse
from asana_python_sdk.type.project_update_request import ProjectUpdateRequest

from ...api_client import Dictionary
from asana_python_sdk.pydantic.projects_update_project_record_response import ProjectsUpdateProjectRecordResponse as ProjectsUpdateProjectRecordResponsePydantic
from asana_python_sdk.pydantic.error_response import ErrorResponse as ErrorResponsePydantic
from asana_python_sdk.pydantic.projects_update_project_record_request import ProjectsUpdateProjectRecordRequest as ProjectsUpdateProjectRecordRequestPydantic
from asana_python_sdk.pydantic.project_update_request import ProjectUpdateRequest as ProjectUpdateRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = ProjectsUpdateProjectRecordRequestSchema


request_body_projects_update_project_record_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ProjectsUpdateProjectRecordResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ProjectsUpdateProjectRecordResponse
...
class BaseApi(api_client.Api):
    ...
    def _update_project_record_mapped_args(
        self,
        project_gid: str,
        data: typing.Optional[ProjectUpdateRequest] = None,
    ...
    async def _aupdate_project_record_oapg(
        self,
        ...
        **kwargs,
        ...
        serialized_data = request_body_projects_update_project_record_request.serialize(body, content_type)
    ...
    def _update_project_record_oapg(
        self,
        body: typing.Any = None,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
...
class UpdateProjectRecordRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_project_record(
        self,
        project_gid: str,
        data: typing.Optional[ProjectUpdateRequest] = None,
        opt_pretty: typing.Optional[bool] = None,
        ...
        **kwargs,
        ...
        args = self._update_project_record_mapped_args(
            project_gid=project_gid,
            data=data,
            opt_pretty=opt_pretty,
            opt_fields=opt_fields,
        )
        return await self._aupdate_project_record_oapg(
            body=args.body,
    ...
    def update_project_record(
        ...
        return self._update_project_record_oapg(
            body=args.body,
            query_params=args.query,
            path_params=args.path,
        )

class UpdateProjectRecord(BaseApi):
    ...
    async def aupdate_project_record(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ProjectsUpdateProjectRecordResponsePydantic:
        raw_response = await self.raw.aupdate_project_record(
            project_gid=project_gid,
            data=data,
            opt_pretty=opt_pretty,
            opt_fields=opt_fields,
        ...
        if validate:
            return ProjectsUpdateProjectRecordResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(ProjectsUpdateProjectRecordResponsePydantic, raw_response.body)
    ...
    def update_project_record(
        ...
        raw_response = self.raw.update_project_record(
            project_gid=project_gid,
            data=data,
            opt_pretty=opt_pretty,
            opt_fields=opt_fields,
