...
from asana_python_sdk.model.projects_get_project_record_response import ProjectsGetProjectRecordResponse as ProjectsGetProjectRecordResponseSchema
...
from asana_python_sdk.type.projects_get_project_record_response import ProjectsGetProjectRecordResponse

from ...api_client import Dictionary
from asana_python_sdk.pydantic.error_response import ErrorResponse as ErrorResponsePydantic
from asana_python_sdk.pydantic.projects_get_project_record_response import ProjectsGetProjectRecordResponse as ProjectsGetProjectRecordResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = ProjectsGetProjectRecordResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ProjectsGetProjectRecordResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_project_record_mapped_args(
        self,
        project_gid: str,
    ...
    async def _aget_project_record_oapg(
        self,
...
class GetProjectRecordRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_project_record(
        self,
        project_gid: str,
        opt_pretty: typing.Optional[bool] = None,
        opt_fields: typing.Optional[typing.List[str]] = None,
        **kwargs,
        ...
        args = self._get_project_record_mapped_args(
            project_gid=project_gid,
            opt_pretty=opt_pretty,
            opt_fields=opt_fields,
        )
        return await self._aget_project_record_oapg(
    ...
    def get_project_record(
        ...
        return self._get_project_record_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetProjectRecord(BaseApi):
    ...
    async def aget_project_record(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ProjectsGetProjectRecordResponsePydantic:
        raw_response = await self.raw.aget_project_record(
            project_gid=project_gid,
            opt_pretty=opt_pretty,
            opt_fields=opt_fields,
            **kwargs,
        ...
        if validate:
            return ProjectsGetProjectRecordResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(ProjectsGetProjectRecordResponsePydantic, raw_response.body)
    ...
    def get_project_record(
        ...
        raw_response = self.raw.get_project_record(
            project_gid=project_gid,
            opt_pretty=opt_pretty,
            opt_fields=opt_fields,
        )
