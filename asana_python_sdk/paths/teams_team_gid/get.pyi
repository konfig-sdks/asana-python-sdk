...
from asana_python_sdk.model.teams_get_team_record_response import TeamsGetTeamRecordResponse as TeamsGetTeamRecordResponseSchema
from asana_python_sdk.model.error_response import ErrorResponse as ErrorResponseSchema

from asana_python_sdk.type.teams_get_team_record_response import TeamsGetTeamRecordResponse
...
from asana_python_sdk.pydantic.teams_get_team_record_response import TeamsGetTeamRecordResponse as TeamsGetTeamRecordResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = TeamsGetTeamRecordResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: TeamsGetTeamRecordResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_team_record_mapped_args(
        self,
        team_gid: str,
    ...
    async def _aget_team_record_oapg(
        self,
...
class GetTeamRecordRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_team_record(
        self,
        team_gid: str,
        opt_pretty: typing.Optional[bool] = None,
        opt_fields: typing.Optional[typing.List[str]] = None,
        **kwargs,
        ...
        args = self._get_team_record_mapped_args(
            team_gid=team_gid,
            opt_pretty=opt_pretty,
            opt_fields=opt_fields,
        )
        return await self._aget_team_record_oapg(
    ...
    def get_team_record(
        ...
        return self._get_team_record_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetTeamRecord(BaseApi):
    ...
    async def aget_team_record(
        ...
        validate: bool = False,
        **kwargs,
    ) -> TeamsGetTeamRecordResponsePydantic:
        raw_response = await self.raw.aget_team_record(
            team_gid=team_gid,
            opt_pretty=opt_pretty,
            opt_fields=opt_fields,
            **kwargs,
        ...
        if validate:
            return TeamsGetTeamRecordResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(TeamsGetTeamRecordResponsePydantic, raw_response.body)
    ...
    def get_team_record(
        ...
        raw_response = self.raw.get_team_record(
            team_gid=team_gid,
            opt_pretty=opt_pretty,
            opt_fields=opt_fields,
        )
