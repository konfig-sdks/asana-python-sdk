...
from asana_python_sdk.model.tags_list_filtered_tags_response import TagsListFilteredTagsResponse as TagsListFilteredTagsResponseSchema
from asana_python_sdk.model.error_response import ErrorResponse as ErrorResponseSchema

from asana_python_sdk.type.tags_list_filtered_tags_response import TagsListFilteredTagsResponse
...
from asana_python_sdk.pydantic.tags_list_filtered_tags_response import TagsListFilteredTagsResponse as TagsListFilteredTagsResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = TagsListFilteredTagsResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: TagsListFilteredTagsResponse
...
class BaseApi(api_client.Api):
    ...
    def _list_filtered_tags_mapped_args(
        self,
    ...
    async def _alist_filtered_tags_oapg(
        self,
...
class ListFilteredTagsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_filtered_tags(
        self,
        opt_pretty: typing.Optional[bool] = None,
        limit: typing.Optional[int] = None,
        offset: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._list_filtered_tags_mapped_args(
        ...
        return await self._alist_filtered_tags_oapg(
            query_params=args.query,
            **kwargs,
        )
    
    def list_filtered_tags(
        self,
        opt_pretty: typing.Optional[bool] = None,
        limit: typing.Optional[int] = None,
        offset: typing.Optional[str] = None,
        ...
        return self._list_filtered_tags_oapg(
            query_params=args.query,
        )

class ListFilteredTags(BaseApi):
    ...
    async def alist_filtered_tags(
        ...
        validate: bool = False,
        **kwargs,
    ) -> TagsListFilteredTagsResponsePydantic:
        raw_response = await self.raw.alist_filtered_tags(
            opt_pretty=opt_pretty,
            limit=limit,
            offset=offset,
            workspace=workspace,
        ...
        if validate:
            return TagsListFilteredTagsResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(TagsListFilteredTagsResponsePydantic, raw_response.body)
    ...
    def list_filtered_tags(
        ...
        raw_response = self.raw.list_filtered_tags(
            opt_pretty=opt_pretty,
            limit=limit,
            offset=offset,
            workspace=workspace,
