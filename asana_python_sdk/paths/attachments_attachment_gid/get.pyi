...
from asana_python_sdk.model.attachments_get_attachment_record_response import AttachmentsGetAttachmentRecordResponse as AttachmentsGetAttachmentRecordResponseSchema
from asana_python_sdk.model.error_response import ErrorResponse as ErrorResponseSchema

from asana_python_sdk.type.attachments_get_attachment_record_response import AttachmentsGetAttachmentRecordResponse
...
from asana_python_sdk.pydantic.attachments_get_attachment_record_response import AttachmentsGetAttachmentRecordResponse as AttachmentsGetAttachmentRecordResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = AttachmentsGetAttachmentRecordResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: AttachmentsGetAttachmentRecordResponse
...
SchemaFor424ResponseBodyApplicationJson = ErrorResponseSchema
...
@dataclass
class ApiResponseFor424Async(api_client.AsyncApiResponse):
    body: ErrorResponse


_response_for_424 = api_client.OpenApiResponse(
    response_cls=ApiResponseFor424,
    response_cls_async=ApiResponseFor424Async,
    content={
        'application/json': api_client.MediaType(
...
SchemaFor501ResponseBodyApplicationJson = ErrorResponseSchema
...
class BaseApi(api_client.Api):
    ...
    def _get_attachment_record_mapped_args(
        self,
        attachment_gid: str,
    ...
    async def _aget_attachment_record_oapg(
        self,
    ...
    def _get_attachment_record_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetAttachmentRecordRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_attachment_record(
        self,
        attachment_gid: str,
        opt_pretty: typing.Optional[bool] = None,
        opt_fields: typing.Optional[typing.List[str]] = None,
        **kwargs,
        ...
        args = self._get_attachment_record_mapped_args(
            attachment_gid=attachment_gid,
            opt_pretty=opt_pretty,
            opt_fields=opt_fields,
        )
        return await self._aget_attachment_record_oapg(
    ...
    def get_attachment_record(
        ...
        return self._get_attachment_record_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetAttachmentRecord(BaseApi):
    ...
    async def aget_attachment_record(
        ...
        validate: bool = False,
        **kwargs,
    ) -> AttachmentsGetAttachmentRecordResponsePydantic:
        raw_response = await self.raw.aget_attachment_record(
            attachment_gid=attachment_gid,
            opt_pretty=opt_pretty,
            opt_fields=opt_fields,
            **kwargs,
        ...
        if validate:
            return AttachmentsGetAttachmentRecordResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(AttachmentsGetAttachmentRecordResponsePydantic, raw_response.body)
    ...
    def get_attachment_record(
        ...
        raw_response = self.raw.get_attachment_record(
            attachment_gid=attachment_gid,
            opt_pretty=opt_pretty,
            opt_fields=opt_fields,
        )
