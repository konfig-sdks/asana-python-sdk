...
from asana_python_sdk.model.team_memberships_get_user_compact_response import TeamMembershipsGetUserCompactResponse as TeamMembershipsGetUserCompactResponseSchema
from asana_python_sdk.model.error_response import ErrorResponse as ErrorResponseSchema

from asana_python_sdk.type.team_memberships_get_user_compact_response import TeamMembershipsGetUserCompactResponse
...
from asana_python_sdk.pydantic.team_memberships_get_user_compact_response import TeamMembershipsGetUserCompactResponse as TeamMembershipsGetUserCompactResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = TeamMembershipsGetUserCompactResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: TeamMembershipsGetUserCompactResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_user_compact_mapped_args(
        self,
        user_gid: str,
        workspace: str,
    ...
    async def _aget_user_compact_oapg(
        self,
...
class GetUserCompactRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_user_compact(
        self,
        user_gid: str,
        workspace: str,
        opt_pretty: typing.Optional[bool] = None,
        ...
        **kwargs,
        ...
        args = self._get_user_compact_mapped_args(
            user_gid=user_gid,
            workspace=workspace,
        ...
        return await self._aget_user_compact_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def get_user_compact(
        self,
        user_gid: str,
        workspace: str,
        opt_pretty: typing.Optional[bool] = None,
        ...
        return self._get_user_compact_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetUserCompact(BaseApi):
    ...
    async def aget_user_compact(
        ...
        validate: bool = False,
        **kwargs,
    ) -> TeamMembershipsGetUserCompactResponsePydantic:
        raw_response = await self.raw.aget_user_compact(
            user_gid=user_gid,
            workspace=workspace,
            opt_pretty=opt_pretty,
            limit=limit,
        ...
        if validate:
            return TeamMembershipsGetUserCompactResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(TeamMembershipsGetUserCompactResponsePydantic, raw_response.body)
    ...
    def get_user_compact(
        ...
        raw_response = self.raw.get_user_compact(
            user_gid=user_gid,
            workspace=workspace,
            opt_pretty=opt_pretty,
            limit=limit,
