...
from asana_python_sdk.model.workspaces_list_multiple_response import WorkspacesListMultipleResponse as WorkspacesListMultipleResponseSchema
from asana_python_sdk.model.error_response import ErrorResponse as ErrorResponseSchema

from asana_python_sdk.type.workspaces_list_multiple_response import WorkspacesListMultipleResponse
...
from asana_python_sdk.pydantic.workspaces_list_multiple_response import WorkspacesListMultipleResponse as WorkspacesListMultipleResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = WorkspacesListMultipleResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: WorkspacesListMultipleResponse
...
class ListMultiple(BaseApi):
    ...
    async def alist_multiple(
        ...
        validate: bool = False,
        **kwargs,
    ) -> WorkspacesListMultipleResponsePydantic:
        ...
        if validate:
            return WorkspacesListMultipleResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(WorkspacesListMultipleResponsePydantic, raw_response.body)
