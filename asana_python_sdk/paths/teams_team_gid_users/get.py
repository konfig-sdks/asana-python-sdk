...
from asana_python_sdk.model.users_list_team_users_response import UsersListTeamUsersResponse as UsersListTeamUsersResponseSchema
from asana_python_sdk.model.error_response import ErrorResponse as ErrorResponseSchema

from asana_python_sdk.type.users_list_team_users_response import UsersListTeamUsersResponse
...
from asana_python_sdk.pydantic.users_list_team_users_response import UsersListTeamUsersResponse as UsersListTeamUsersResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = UsersListTeamUsersResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: UsersListTeamUsersResponse
...
class BaseApi(api_client.Api):
    ...
    def _list_team_users_mapped_args(
        self,
        team_gid: str,
    ...
    async def _alist_team_users_oapg(
        self,
...
class ListTeamUsersRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_team_users(
        self,
        team_gid: str,
        opt_pretty: typing.Optional[bool] = None,
        offset: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._list_team_users_mapped_args(
            team_gid=team_gid,
            opt_pretty=opt_pretty,
            offset=offset,
            opt_fields=opt_fields,
        )
        return await self._alist_team_users_oapg(
...
class ListTeamUsers(BaseApi):
    ...
    async def alist_team_users(
        ...
        validate: bool = False,
        **kwargs,
    ) -> UsersListTeamUsersResponsePydantic:
        raw_response = await self.raw.alist_team_users(
            team_gid=team_gid,
            opt_pretty=opt_pretty,
            offset=offset,
            opt_fields=opt_fields,
        ...
        if validate:
            return UsersListTeamUsersResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(UsersListTeamUsersResponsePydantic, raw_response.body)
    ...
    def list_team_users(
        ...
        raw_response = self.raw.list_team_users(
            team_gid=team_gid,
            opt_pretty=opt_pretty,
            offset=offset,
            opt_fields=opt_fields,
