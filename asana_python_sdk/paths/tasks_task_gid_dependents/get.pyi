...
from asana_python_sdk.model.tasks_get_dependents_response import TasksGetDependentsResponse as TasksGetDependentsResponseSchema
from asana_python_sdk.model.error_response import ErrorResponse as ErrorResponseSchema

from asana_python_sdk.type.tasks_get_dependents_response import TasksGetDependentsResponse
...
from asana_python_sdk.pydantic.tasks_get_dependents_response import TasksGetDependentsResponse as TasksGetDependentsResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = TasksGetDependentsResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: TasksGetDependentsResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_dependents_mapped_args(
        self,
        task_gid: str,
    ...
    async def _aget_dependents_oapg(
        self,
...
class GetDependentsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_dependents(
        self,
        task_gid: str,
        opt_pretty: typing.Optional[bool] = None,
        limit: typing.Optional[int] = None,
        ...
        **kwargs,
        ...
        args = self._get_dependents_mapped_args(
            task_gid=task_gid,
        ...
        return await self._aget_dependents_oapg(
    ...
    def get_dependents(
        ...
        return self._get_dependents_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetDependents(BaseApi):
    ...
    async def aget_dependents(
        ...
        validate: bool = False,
        **kwargs,
    ) -> TasksGetDependentsResponsePydantic:
        raw_response = await self.raw.aget_dependents(
            task_gid=task_gid,
            opt_pretty=opt_pretty,
            limit=limit,
            offset=offset,
        ...
        if validate:
            return TasksGetDependentsResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(TasksGetDependentsResponsePydantic, raw_response.body)
    ...
    def get_dependents(
        ...
        raw_response = self.raw.get_dependents(
            task_gid=task_gid,
            opt_pretty=opt_pretty,
            limit=limit,
            offset=offset,
