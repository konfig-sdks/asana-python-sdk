...
from asana_python_sdk.model.goals_remove_followers_from_goal_response import GoalsRemoveFollowersFromGoalResponse as GoalsRemoveFollowersFromGoalResponseSchema
from asana_python_sdk.model.goals_remove_followers_from_goal_request import GoalsRemoveFollowersFromGoalRequest as GoalsRemoveFollowersFromGoalRequestSchema
from asana_python_sdk.model.task_add_followers_request import TaskAddFollowersRequest as TaskAddFollowersRequestSchema
from asana_python_sdk.model.error_response import ErrorResponse as ErrorResponseSchema

from asana_python_sdk.type.goals_remove_followers_from_goal_request import GoalsRemoveFollowersFromGoalRequest
from asana_python_sdk.type.goals_remove_followers_from_goal_response import GoalsRemoveFollowersFromGoalResponse
from asana_python_sdk.type.task_add_followers_request import TaskAddFollowersRequest
from asana_python_sdk.type.error_response import ErrorResponse

from ...api_client import Dictionary
from asana_python_sdk.pydantic.goals_remove_followers_from_goal_request import GoalsRemoveFollowersFromGoalRequest as GoalsRemoveFollowersFromGoalRequestPydantic
from asana_python_sdk.pydantic.goals_remove_followers_from_goal_response import GoalsRemoveFollowersFromGoalResponse as GoalsRemoveFollowersFromGoalResponsePydantic
from asana_python_sdk.pydantic.task_add_followers_request import TaskAddFollowersRequest as TaskAddFollowersRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = GoalsRemoveFollowersFromGoalRequestSchema


request_body_goals_remove_followers_from_goal_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = GoalsRemoveFollowersFromGoalResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: GoalsRemoveFollowersFromGoalResponse
...
class BaseApi(api_client.Api):
    ...
    def _remove_followers_from_goal_mapped_args(
        self,
        goal_gid: str,
        data: typing.Optional[TaskAddFollowersRequest] = None,
    ...
    async def _aremove_followers_from_goal_oapg(
        self,
        ...
        **kwargs,
        ...
        serialized_data = request_body_goals_remove_followers_from_goal_request.serialize(body, content_type)
    ...
    def _remove_followers_from_goal_oapg(
        self,
        body: typing.Any = None,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
...
class RemoveFollowersFromGoalRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aremove_followers_from_goal(
        self,
        goal_gid: str,
        data: typing.Optional[TaskAddFollowersRequest] = None,
        opt_pretty: typing.Optional[bool] = None,
        ...
        **kwargs,
        ...
        args = self._remove_followers_from_goal_mapped_args(
            goal_gid=goal_gid,
            data=data,
            opt_pretty=opt_pretty,
            opt_fields=opt_fields,
        )
        return await self._aremove_followers_from_goal_oapg(
            body=args.body,
    ...
    def remove_followers_from_goal(
        self,
        goal_gid: str,
        data: typing.Optional[TaskAddFollowersRequest] = None,
        opt_pretty: typing.Optional[bool] = None,
        ...
        return self._remove_followers_from_goal_oapg(
            body=args.body,
            query_params=args.query,
            path_params=args.path,
        )

class RemoveFollowersFromGoal(BaseApi):
    ...
    async def aremove_followers_from_goal(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GoalsRemoveFollowersFromGoalResponsePydantic:
        raw_response = await self.raw.aremove_followers_from_goal(
            goal_gid=goal_gid,
            data=data,
            opt_pretty=opt_pretty,
            opt_fields=opt_fields,
        ...
        if validate:
            return GoalsRemoveFollowersFromGoalResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(GoalsRemoveFollowersFromGoalResponsePydantic, raw_response.body)
    ...
    def remove_followers_from_goal(
        ...
        raw_response = self.raw.remove_followers_from_goal(
            goal_gid=goal_gid,
            data=data,
            opt_pretty=opt_pretty,
            opt_fields=opt_fields,
