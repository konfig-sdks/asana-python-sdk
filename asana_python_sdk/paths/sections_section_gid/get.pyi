...
from asana_python_sdk.model.sections_get_record_response import SectionsGetRecordResponse as SectionsGetRecordResponseSchema
...
from asana_python_sdk.type.sections_get_record_response import SectionsGetRecordResponse

from ...api_client import Dictionary
from asana_python_sdk.pydantic.error_response import ErrorResponse as ErrorResponsePydantic
from asana_python_sdk.pydantic.sections_get_record_response import SectionsGetRecordResponse as SectionsGetRecordResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = SectionsGetRecordResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: SectionsGetRecordResponse
...
class GetRecord(BaseApi):
    ...
    async def aget_record(
        ...
        validate: bool = False,
        **kwargs,
    ) -> SectionsGetRecordResponsePydantic:
        ...
        if validate:
            return SectionsGetRecordResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(SectionsGetRecordResponsePydantic, raw_response.body)
