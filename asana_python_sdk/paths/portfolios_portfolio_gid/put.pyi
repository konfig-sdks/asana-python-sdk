...
from asana_python_sdk.model.portfolios_update_portfolio_record_response import PortfoliosUpdatePortfolioRecordResponse as PortfoliosUpdatePortfolioRecordResponseSchema
from asana_python_sdk.model.portfolios_update_portfolio_record_request import PortfoliosUpdatePortfolioRecordRequest as PortfoliosUpdatePortfolioRecordRequestSchema
from asana_python_sdk.model.error_response import ErrorResponse as ErrorResponseSchema

from asana_python_sdk.type.portfolios_update_portfolio_record_request import PortfoliosUpdatePortfolioRecordRequest
from asana_python_sdk.type.portfolio_request import PortfolioRequest
from asana_python_sdk.type.portfolios_update_portfolio_record_response import PortfoliosUpdatePortfolioRecordResponse
...
from asana_python_sdk.pydantic.portfolios_update_portfolio_record_request import PortfoliosUpdatePortfolioRecordRequest as PortfoliosUpdatePortfolioRecordRequestPydantic
from asana_python_sdk.pydantic.portfolios_update_portfolio_record_response import PortfoliosUpdatePortfolioRecordResponse as PortfoliosUpdatePortfolioRecordResponsePydantic
...
# body param
SchemaForRequestBodyApplicationJson = PortfoliosUpdatePortfolioRecordRequestSchema


request_body_portfolios_update_portfolio_record_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = PortfoliosUpdatePortfolioRecordResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: PortfoliosUpdatePortfolioRecordResponse
...
class BaseApi(api_client.Api):
    ...
    def _update_portfolio_record_mapped_args(
        self,
        portfolio_gid: str,
    ...
    async def _aupdate_portfolio_record_oapg(
        self,
        ...
        **kwargs,
        ...
        serialized_data = request_body_portfolios_update_portfolio_record_request.serialize(body, content_type)
    ...
    def _update_portfolio_record_oapg(
        self,
        body: typing.Any = None,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
...
class UpdatePortfolioRecordRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_portfolio_record(
        self,
        portfolio_gid: str,
        data: typing.Optional[PortfolioRequest] = None,
        opt_pretty: typing.Optional[bool] = None,
        ...
        **kwargs,
        ...
        args = self._update_portfolio_record_mapped_args(
            portfolio_gid=portfolio_gid,
            data=data,
            opt_pretty=opt_pretty,
            opt_fields=opt_fields,
        )
        return await self._aupdate_portfolio_record_oapg(
            body=args.body,
    ...
    def update_portfolio_record(
        ...
        return self._update_portfolio_record_oapg(
            body=args.body,
            query_params=args.query,
            path_params=args.path,
        )

class UpdatePortfolioRecord(BaseApi):
    ...
    async def aupdate_portfolio_record(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PortfoliosUpdatePortfolioRecordResponsePydantic:
        raw_response = await self.raw.aupdate_portfolio_record(
            portfolio_gid=portfolio_gid,
            data=data,
            opt_pretty=opt_pretty,
            opt_fields=opt_fields,
        ...
        if validate:
            return PortfoliosUpdatePortfolioRecordResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(PortfoliosUpdatePortfolioRecordResponsePydantic, raw_response.body)
    ...
    def update_portfolio_record(
        ...
        raw_response = self.raw.update_portfolio_record(
            portfolio_gid=portfolio_gid,
            data=data,
            opt_pretty=opt_pretty,
            opt_fields=opt_fields,
