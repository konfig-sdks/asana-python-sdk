...
from asana_python_sdk.model.portfolios_delete_record_response import PortfoliosDeleteRecordResponse as PortfoliosDeleteRecordResponseSchema
from asana_python_sdk.model.error_response import ErrorResponse as ErrorResponseSchema

from asana_python_sdk.type.portfolios_delete_record_response import PortfoliosDeleteRecordResponse
from asana_python_sdk.type.error_response import ErrorResponse

from ...api_client import Dictionary
from asana_python_sdk.pydantic.portfolios_delete_record_response import PortfoliosDeleteRecordResponse as PortfoliosDeleteRecordResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = PortfoliosDeleteRecordResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: PortfoliosDeleteRecordResponse
...
class DeleteRecord(BaseApi):
    ...
    async def adelete_record(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PortfoliosDeleteRecordResponsePydantic:
        ...
        if validate:
            return PortfoliosDeleteRecordResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(PortfoliosDeleteRecordResponsePydantic, raw_response.body)
