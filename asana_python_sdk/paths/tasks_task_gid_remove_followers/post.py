...
from asana_python_sdk.model.task_remove_followers_request import TaskRemoveFollowersRequest as TaskRemoveFollowersRequestSchema
from asana_python_sdk.model.tasks_remove_followers_from_task_request import TasksRemoveFollowersFromTaskRequest as TasksRemoveFollowersFromTaskRequestSchema
from asana_python_sdk.model.tasks_remove_followers_from_task_response import TasksRemoveFollowersFromTaskResponse as TasksRemoveFollowersFromTaskResponseSchema
from asana_python_sdk.model.error_response import ErrorResponse as ErrorResponseSchema

from asana_python_sdk.type.task_remove_followers_request import TaskRemoveFollowersRequest
from asana_python_sdk.type.tasks_remove_followers_from_task_request import TasksRemoveFollowersFromTaskRequest
from asana_python_sdk.type.tasks_remove_followers_from_task_response import TasksRemoveFollowersFromTaskResponse
from asana_python_sdk.type.error_response import ErrorResponse

from ...api_client import Dictionary
from asana_python_sdk.pydantic.tasks_remove_followers_from_task_request import TasksRemoveFollowersFromTaskRequest as TasksRemoveFollowersFromTaskRequestPydantic
from asana_python_sdk.pydantic.task_remove_followers_request import TaskRemoveFollowersRequest as TaskRemoveFollowersRequestPydantic
from asana_python_sdk.pydantic.error_response import ErrorResponse as ErrorResponsePydantic
from asana_python_sdk.pydantic.tasks_remove_followers_from_task_response import TasksRemoveFollowersFromTaskResponse as TasksRemoveFollowersFromTaskResponsePydantic
...
# body param
SchemaForRequestBodyApplicationJson = TasksRemoveFollowersFromTaskRequestSchema


request_body_tasks_remove_followers_from_task_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = TasksRemoveFollowersFromTaskResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: TasksRemoveFollowersFromTaskResponse
...
class BaseApi(api_client.Api):
    ...
    def _remove_followers_from_task_mapped_args(
        self,
        task_gid: str,
        data: typing.Optional[TaskRemoveFollowersRequest] = None,
    ...
    async def _aremove_followers_from_task_oapg(
        self,
        ...
        **kwargs,
        ...
        serialized_data = request_body_tasks_remove_followers_from_task_request.serialize(body, content_type)
    ...
    def _remove_followers_from_task_oapg(
        self,
        body: typing.Any = None,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
...
class RemoveFollowersFromTaskRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aremove_followers_from_task(
        self,
        task_gid: str,
        data: typing.Optional[TaskRemoveFollowersRequest] = None,
        opt_pretty: typing.Optional[bool] = None,
        ...
        **kwargs,
        ...
        args = self._remove_followers_from_task_mapped_args(
            task_gid=task_gid,
            data=data,
            opt_pretty=opt_pretty,
            opt_fields=opt_fields,
        )
        return await self._aremove_followers_from_task_oapg(
            body=args.body,
    ...
    def remove_followers_from_task(
        ...
        return self._remove_followers_from_task_oapg(
            body=args.body,
            query_params=args.query,
            path_params=args.path,
        )

class RemoveFollowersFromTask(BaseApi):
    ...
    async def aremove_followers_from_task(
        ...
        validate: bool = False,
        **kwargs,
    ) -> TasksRemoveFollowersFromTaskResponsePydantic:
        raw_response = await self.raw.aremove_followers_from_task(
            task_gid=task_gid,
            data=data,
            opt_pretty=opt_pretty,
            opt_fields=opt_fields,
        ...
        if validate:
            return TasksRemoveFollowersFromTaskResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(TasksRemoveFollowersFromTaskResponsePydantic, raw_response.body)
    ...
    def remove_followers_from_task(
        ...
        raw_response = self.raw.remove_followers_from_task(
            task_gid=task_gid,
            data=data,
            opt_pretty=opt_pretty,
            opt_fields=opt_fields,
