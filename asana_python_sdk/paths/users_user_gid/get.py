...
from asana_python_sdk.model.users_get_user_record_response import UsersGetUserRecordResponse as UsersGetUserRecordResponseSchema
from asana_python_sdk.model.error_response import ErrorResponse as ErrorResponseSchema

from asana_python_sdk.type.users_get_user_record_response import UsersGetUserRecordResponse
...
from asana_python_sdk.pydantic.users_get_user_record_response import UsersGetUserRecordResponse as UsersGetUserRecordResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = UsersGetUserRecordResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: UsersGetUserRecordResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_user_record_mapped_args(
        self,
        user_gid: str,
    ...
    async def _aget_user_record_oapg(
        self,
...
class GetUserRecordRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_user_record(
        self,
        user_gid: str,
        opt_pretty: typing.Optional[bool] = None,
        opt_fields: typing.Optional[typing.List[str]] = None,
        **kwargs,
        ...
        args = self._get_user_record_mapped_args(
            user_gid=user_gid,
            opt_pretty=opt_pretty,
            opt_fields=opt_fields,
        )
        return await self._aget_user_record_oapg(
    ...
    def get_user_record(
        ...
        return self._get_user_record_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetUserRecord(BaseApi):
    ...
    async def aget_user_record(
        ...
        validate: bool = False,
        **kwargs,
    ) -> UsersGetUserRecordResponsePydantic:
        raw_response = await self.raw.aget_user_record(
            user_gid=user_gid,
            opt_pretty=opt_pretty,
            opt_fields=opt_fields,
            **kwargs,
        ...
        if validate:
            return UsersGetUserRecordResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(UsersGetUserRecordResponsePydantic, raw_response.body)
    ...
    def get_user_record(
        ...
        raw_response = self.raw.get_user_record(
            user_gid=user_gid,
            opt_pretty=opt_pretty,
            opt_fields=opt_fields,
        )
