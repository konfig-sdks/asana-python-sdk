...
from asana_python_sdk.model.projects_get_team_projects_response import ProjectsGetTeamProjectsResponse as ProjectsGetTeamProjectsResponseSchema
from asana_python_sdk.model.error_response import ErrorResponse as ErrorResponseSchema

from asana_python_sdk.type.projects_get_team_projects_response import ProjectsGetTeamProjectsResponse
from asana_python_sdk.type.error_response import ErrorResponse

from ...api_client import Dictionary
from asana_python_sdk.pydantic.projects_get_team_projects_response import ProjectsGetTeamProjectsResponse as ProjectsGetTeamProjectsResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = ProjectsGetTeamProjectsResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ProjectsGetTeamProjectsResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_team_projects_mapped_args(
        self,
        team_gid: str,
    ...
    async def _aget_team_projects_oapg(
        self,
...
class GetTeamProjectsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_team_projects(
        self,
        team_gid: str,
        opt_pretty: typing.Optional[bool] = None,
        limit: typing.Optional[int] = None,
        ...
        **kwargs,
        ...
        args = self._get_team_projects_mapped_args(
            team_gid=team_gid,
        ...
        return await self._aget_team_projects_oapg(
    ...
    def get_team_projects(
        ...
        return self._get_team_projects_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetTeamProjects(BaseApi):
    ...
    async def aget_team_projects(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ProjectsGetTeamProjectsResponsePydantic:
        raw_response = await self.raw.aget_team_projects(
            team_gid=team_gid,
            opt_pretty=opt_pretty,
            limit=limit,
            offset=offset,
        ...
        if validate:
            return ProjectsGetTeamProjectsResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(ProjectsGetTeamProjectsResponsePydantic, raw_response.body)
    ...
    def get_team_projects(
        ...
        raw_response = self.raw.get_team_projects(
            team_gid=team_gid,
            opt_pretty=opt_pretty,
            limit=limit,
            offset=offset,
