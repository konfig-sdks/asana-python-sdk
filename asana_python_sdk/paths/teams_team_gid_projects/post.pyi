...
from asana_python_sdk.model.projects_create_project_for_team_response import ProjectsCreateProjectForTeamResponse as ProjectsCreateProjectForTeamResponseSchema
from asana_python_sdk.model.projects_create_project_for_team_request import ProjectsCreateProjectForTeamRequest as ProjectsCreateProjectForTeamRequestSchema
...
from asana_python_sdk.type.projects_create_project_for_team_response import ProjectsCreateProjectForTeamResponse
from asana_python_sdk.type.projects_create_project_for_team_request import ProjectsCreateProjectForTeamRequest
...
from asana_python_sdk.pydantic.projects_create_project_for_team_response import ProjectsCreateProjectForTeamResponse as ProjectsCreateProjectForTeamResponsePydantic
from asana_python_sdk.pydantic.project_request import ProjectRequest as ProjectRequestPydantic
from asana_python_sdk.pydantic.projects_create_project_for_team_request import ProjectsCreateProjectForTeamRequest as ProjectsCreateProjectForTeamRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = ProjectsCreateProjectForTeamRequestSchema


request_body_projects_create_project_for_team_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = ProjectsCreateProjectForTeamResponseSchema


@dataclass
class ApiResponseFor201(api_client.ApiResponse):
    body: ProjectsCreateProjectForTeamResponse
...
class BaseApi(api_client.Api):
    ...
    def _create_project_for_team_mapped_args(
        self,
        team_gid: str,
    ...
    async def _acreate_project_for_team_oapg(
        self,
        ...
        **kwargs,
        ...
        serialized_data = request_body_projects_create_project_for_team_request.serialize(body, content_type)
...
class CreateProjectForTeamRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_project_for_team(
        self,
        team_gid: str,
        data: typing.Optional[ProjectRequest] = None,
        opt_pretty: typing.Optional[bool] = None,
        ...
        **kwargs,
        ...
        args = self._create_project_for_team_mapped_args(
            team_gid=team_gid,
            data=data,
            opt_pretty=opt_pretty,
            opt_fields=opt_fields,
        )
        return await self._acreate_project_for_team_oapg(
            body=args.body,
...
class CreateProjectForTeam(BaseApi):
    ...
    async def acreate_project_for_team(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ProjectsCreateProjectForTeamResponsePydantic:
        raw_response = await self.raw.acreate_project_for_team(
            team_gid=team_gid,
            data=data,
            opt_pretty=opt_pretty,
            opt_fields=opt_fields,
        ...
        if validate:
            return ProjectsCreateProjectForTeamResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(ProjectsCreateProjectForTeamResponsePydantic, raw_response.body)
    ...
    def create_project_for_team(
        ...
        raw_response = self.raw.create_project_for_team(
            team_gid=team_gid,
            data=data,
            opt_pretty=opt_pretty,
            opt_fields=opt_fields,
