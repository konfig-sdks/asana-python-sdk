...
from asana_python_sdk.model.tasks_get_task_record_response import TasksGetTaskRecordResponse as TasksGetTaskRecordResponseSchema
from asana_python_sdk.model.error_response import ErrorResponse as ErrorResponseSchema

from asana_python_sdk.type.tasks_get_task_record_response import TasksGetTaskRecordResponse
...
from asana_python_sdk.pydantic.tasks_get_task_record_response import TasksGetTaskRecordResponse as TasksGetTaskRecordResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = TasksGetTaskRecordResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: TasksGetTaskRecordResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_task_record_mapped_args(
        self,
        task_gid: str,
    ...
    async def _aget_task_record_oapg(
        self,
...
class GetTaskRecordRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_task_record(
        self,
        task_gid: str,
        opt_pretty: typing.Optional[bool] = None,
        opt_fields: typing.Optional[typing.List[str]] = None,
        **kwargs,
        ...
        args = self._get_task_record_mapped_args(
            task_gid=task_gid,
            opt_pretty=opt_pretty,
            opt_fields=opt_fields,
        )
        return await self._aget_task_record_oapg(
    ...
    def get_task_record(
        ...
        return self._get_task_record_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetTaskRecord(BaseApi):
    ...
    async def aget_task_record(
        ...
        validate: bool = False,
        **kwargs,
    ) -> TasksGetTaskRecordResponsePydantic:
        raw_response = await self.raw.aget_task_record(
            task_gid=task_gid,
            opt_pretty=opt_pretty,
            opt_fields=opt_fields,
            **kwargs,
        ...
        if validate:
            return TasksGetTaskRecordResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(TasksGetTaskRecordResponsePydantic, raw_response.body)
    ...
    def get_task_record(
        ...
        raw_response = self.raw.get_task_record(
            task_gid=task_gid,
            opt_pretty=opt_pretty,
            opt_fields=opt_fields,
        )
