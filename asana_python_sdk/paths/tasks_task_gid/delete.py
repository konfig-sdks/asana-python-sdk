...
from asana_python_sdk.model.tasks_delete_task_response import TasksDeleteTaskResponse as TasksDeleteTaskResponseSchema
from asana_python_sdk.model.error_response import ErrorResponse as ErrorResponseSchema

from asana_python_sdk.type.tasks_delete_task_response import TasksDeleteTaskResponse
...
from asana_python_sdk.pydantic.tasks_delete_task_response import TasksDeleteTaskResponse as TasksDeleteTaskResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = TasksDeleteTaskResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: TasksDeleteTaskResponse
...
class DeleteTaskRaw(BaseApi):
    ...
    async def adelete_task(
        ...
        **kwargs,
        ...
        args = self._delete_task_mapped_args(
            task_gid=task_gid,
            opt_pretty=opt_pretty,
        )
        return await self._adelete_task_oapg(
...
class DeleteTask(BaseApi):
    ...
    async def adelete_task(
        ...
        validate: bool = False,
        **kwargs,
    ) -> TasksDeleteTaskResponsePydantic:
        raw_response = await self.raw.adelete_task(
            task_gid=task_gid,
            opt_pretty=opt_pretty,
            **kwargs,
        )
        if validate:
            return TasksDeleteTaskResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(TasksDeleteTaskResponsePydantic, raw_response.body)
    ...
    def delete_task(
        ...
        raw_response = self.raw.delete_task(
            task_gid=task_gid,
            opt_pretty=opt_pretty,
        )
        if validate:
