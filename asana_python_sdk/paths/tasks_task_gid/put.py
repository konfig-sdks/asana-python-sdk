...
from asana_python_sdk.model.tasks_update_task_record_request import TasksUpdateTaskRecordRequest as TasksUpdateTaskRecordRequestSchema
from asana_python_sdk.model.tasks_update_task_record_response import TasksUpdateTaskRecordResponse as TasksUpdateTaskRecordResponseSchema
from asana_python_sdk.model.error_response import ErrorResponse as ErrorResponseSchema

from asana_python_sdk.type.tasks_update_task_record_response import TasksUpdateTaskRecordResponse
from asana_python_sdk.type.tasks_update_task_record_request import TasksUpdateTaskRecordRequest
...
from asana_python_sdk.pydantic.tasks_update_task_record_response import TasksUpdateTaskRecordResponse as TasksUpdateTaskRecordResponsePydantic
...
from asana_python_sdk.pydantic.tasks_update_task_record_request import TasksUpdateTaskRecordRequest as TasksUpdateTaskRecordRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = TasksUpdateTaskRecordRequestSchema


request_body_tasks_update_task_record_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = TasksUpdateTaskRecordResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: TasksUpdateTaskRecordResponse
...
class BaseApi(api_client.Api):
    ...
    def _update_task_record_mapped_args(
        self,
        task_gid: str,
    ...
    async def _aupdate_task_record_oapg(
        self,
        ...
        **kwargs,
        ...
        serialized_data = request_body_tasks_update_task_record_request.serialize(body, content_type)
...
class UpdateTaskRecordRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_task_record(
        self,
        task_gid: str,
        data: typing.Optional[TaskRequest] = None,
        opt_pretty: typing.Optional[bool] = None,
        ...
        **kwargs,
        ...
        args = self._update_task_record_mapped_args(
            task_gid=task_gid,
            data=data,
            opt_pretty=opt_pretty,
            opt_fields=opt_fields,
        )
        return await self._aupdate_task_record_oapg(
            body=args.body,
    ...
    def update_task_record(
        ...
        return self._update_task_record_oapg(
            body=args.body,
            query_params=args.query,
            path_params=args.path,
        )

class UpdateTaskRecord(BaseApi):
    ...
    async def aupdate_task_record(
        ...
        validate: bool = False,
        **kwargs,
    ) -> TasksUpdateTaskRecordResponsePydantic:
        raw_response = await self.raw.aupdate_task_record(
            task_gid=task_gid,
            data=data,
            opt_pretty=opt_pretty,
            opt_fields=opt_fields,
        ...
        if validate:
            return TasksUpdateTaskRecordResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(TasksUpdateTaskRecordResponsePydantic, raw_response.body)
    ...
    def update_task_record(
        ...
        raw_response = self.raw.update_task_record(
            task_gid=task_gid,
            data=data,
            opt_pretty=opt_pretty,
            opt_fields=opt_fields,
