...
from asana_python_sdk.model.goals_get_parent_goals_response import GoalsGetParentGoalsResponse as GoalsGetParentGoalsResponseSchema
from asana_python_sdk.model.error_response import ErrorResponse as ErrorResponseSchema

from asana_python_sdk.type.goals_get_parent_goals_response import GoalsGetParentGoalsResponse
...
from asana_python_sdk.pydantic.goals_get_parent_goals_response import GoalsGetParentGoalsResponse as GoalsGetParentGoalsResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = GoalsGetParentGoalsResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: GoalsGetParentGoalsResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_parent_goals_mapped_args(
        self,
        goal_gid: str,
    ...
    async def _aget_parent_goals_oapg(
        self,
...
class GetParentGoalsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_parent_goals(
        self,
        goal_gid: str,
        opt_pretty: typing.Optional[bool] = None,
        opt_fields: typing.Optional[typing.List[str]] = None,
        **kwargs,
        ...
        args = self._get_parent_goals_mapped_args(
            goal_gid=goal_gid,
            opt_pretty=opt_pretty,
            opt_fields=opt_fields,
        )
        return await self._aget_parent_goals_oapg(
    ...
    def get_parent_goals(
        ...
        return self._get_parent_goals_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetParentGoals(BaseApi):
    ...
    async def aget_parent_goals(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GoalsGetParentGoalsResponsePydantic:
        raw_response = await self.raw.aget_parent_goals(
            goal_gid=goal_gid,
            opt_pretty=opt_pretty,
            opt_fields=opt_fields,
            **kwargs,
        ...
        if validate:
            return GoalsGetParentGoalsResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(GoalsGetParentGoalsResponsePydantic, raw_response.body)
    ...
    def get_parent_goals(
        ...
        raw_response = self.raw.get_parent_goals(
            goal_gid=goal_gid,
            opt_pretty=opt_pretty,
            opt_fields=opt_fields,
        )
