...
from asana_python_sdk.model.sections_list_project_sections_response import SectionsListProjectSectionsResponse as SectionsListProjectSectionsResponseSchema
from asana_python_sdk.model.error_response import ErrorResponse as ErrorResponseSchema

from asana_python_sdk.type.sections_list_project_sections_response import SectionsListProjectSectionsResponse
...
from asana_python_sdk.pydantic.sections_list_project_sections_response import SectionsListProjectSectionsResponse as SectionsListProjectSectionsResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = SectionsListProjectSectionsResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: SectionsListProjectSectionsResponse
...
class BaseApi(api_client.Api):
    ...
    def _list_project_sections_mapped_args(
        self,
        project_gid: str,
    ...
    async def _alist_project_sections_oapg(
        self,
    ...
    def _list_project_sections_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class ListProjectSectionsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_project_sections(
        self,
        project_gid: str,
        opt_pretty: typing.Optional[bool] = None,
        limit: typing.Optional[int] = None,
        ...
        **kwargs,
        ...
        args = self._list_project_sections_mapped_args(
        ...
        return await self._alist_project_sections_oapg(
    ...
    def list_project_sections(
        ...
        return self._list_project_sections_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class ListProjectSections(BaseApi):
    ...
    async def alist_project_sections(
        ...
        validate: bool = False,
        **kwargs,
    ) -> SectionsListProjectSectionsResponsePydantic:
        raw_response = await self.raw.alist_project_sections(
            project_gid=project_gid,
            opt_pretty=opt_pretty,
            limit=limit,
            offset=offset,
        ...
        if validate:
            return SectionsListProjectSectionsResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(SectionsListProjectSectionsResponsePydantic, raw_response.body)
    ...
    def list_project_sections(
        ...
        raw_response = self.raw.list_project_sections(
            project_gid=project_gid,
            opt_pretty=opt_pretty,
            limit=limit,
            offset=offset,
