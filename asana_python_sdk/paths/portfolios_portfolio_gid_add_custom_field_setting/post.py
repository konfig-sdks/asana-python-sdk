...
from asana_python_sdk.model.portfolios_add_custom_field_setting_request import PortfoliosAddCustomFieldSettingRequest as PortfoliosAddCustomFieldSettingRequestSchema
...
from asana_python_sdk.model.portfolios_add_custom_field_setting_response import PortfoliosAddCustomFieldSettingResponse as PortfoliosAddCustomFieldSettingResponseSchema
from asana_python_sdk.model.error_response import ErrorResponse as ErrorResponseSchema

from asana_python_sdk.type.portfolios_add_custom_field_setting_response import PortfoliosAddCustomFieldSettingResponse
...
from asana_python_sdk.type.portfolios_add_custom_field_setting_request import PortfoliosAddCustomFieldSettingRequest

from ...api_client import Dictionary
from asana_python_sdk.pydantic.portfolios_add_custom_field_setting_request import PortfoliosAddCustomFieldSettingRequest as PortfoliosAddCustomFieldSettingRequestPydantic
from asana_python_sdk.pydantic.portfolios_add_custom_field_setting_response import PortfoliosAddCustomFieldSettingResponse as PortfoliosAddCustomFieldSettingResponsePydantic
...
# body param
SchemaForRequestBodyApplicationJson = PortfoliosAddCustomFieldSettingRequestSchema


request_body_portfolios_add_custom_field_setting_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = PortfoliosAddCustomFieldSettingResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: PortfoliosAddCustomFieldSettingResponse
...
class BaseApi(api_client.Api):
    ...
    async def _aadd_custom_field_setting_oapg(
        ...
        **kwargs,
        ...
        serialized_data = request_body_portfolios_add_custom_field_setting_request.serialize(body, content_type)
...
class AddCustomFieldSetting(BaseApi):
    ...
    async def aadd_custom_field_setting(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PortfoliosAddCustomFieldSettingResponsePydantic:
        ...
        if validate:
            return PortfoliosAddCustomFieldSettingResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(PortfoliosAddCustomFieldSettingResponsePydantic, raw_response.body)
