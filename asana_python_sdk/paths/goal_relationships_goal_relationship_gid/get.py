...
from asana_python_sdk.model.goal_relationships_get_record_by_id_response import GoalRelationshipsGetRecordByIdResponse as GoalRelationshipsGetRecordByIdResponseSchema
from asana_python_sdk.model.error_response import ErrorResponse as ErrorResponseSchema

from asana_python_sdk.type.goal_relationships_get_record_by_id_response import GoalRelationshipsGetRecordByIdResponse
...
from asana_python_sdk.pydantic.goal_relationships_get_record_by_id_response import GoalRelationshipsGetRecordByIdResponse as GoalRelationshipsGetRecordByIdResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = GoalRelationshipsGetRecordByIdResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: GoalRelationshipsGetRecordByIdResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_record_by_id_mapped_args(
        self,
    ...
    async def _aget_record_by_id_oapg(
        self,
...
class GetRecordByIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_record_by_id(
        self,
        goal_relationship_gid: str,
        opt_pretty: typing.Optional[bool] = None,
        opt_fields: typing.Optional[typing.List[str]] = None,
        **kwargs,
        ...
        args = self._get_record_by_id_mapped_args(
            goal_relationship_gid=goal_relationship_gid,
            opt_pretty=opt_pretty,
            opt_fields=opt_fields,
        )
        return await self._aget_record_by_id_oapg(
    ...
    def get_record_by_id(
        ...
        return self._get_record_by_id_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetRecordById(BaseApi):
    ...
    async def aget_record_by_id(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GoalRelationshipsGetRecordByIdResponsePydantic:
        raw_response = await self.raw.aget_record_by_id(
            goal_relationship_gid=goal_relationship_gid,
            opt_pretty=opt_pretty,
            opt_fields=opt_fields,
            **kwargs,
        ...
        if validate:
            return GoalRelationshipsGetRecordByIdResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(GoalRelationshipsGetRecordByIdResponsePydantic, raw_response.body)
    ...
    def get_record_by_id(
        ...
        raw_response = self.raw.get_record_by_id(
            goal_relationship_gid=goal_relationship_gid,
            opt_pretty=opt_pretty,
            opt_fields=opt_fields,
        )
