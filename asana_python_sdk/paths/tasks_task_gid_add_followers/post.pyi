...
from asana_python_sdk.model.tasks_add_followers_to_task_response import TasksAddFollowersToTaskResponse as TasksAddFollowersToTaskResponseSchema
from asana_python_sdk.model.task_add_followers_request import TaskAddFollowersRequest as TaskAddFollowersRequestSchema
from asana_python_sdk.model.tasks_add_followers_to_task_request import TasksAddFollowersToTaskRequest as TasksAddFollowersToTaskRequestSchema
from asana_python_sdk.model.error_response import ErrorResponse as ErrorResponseSchema

from asana_python_sdk.type.tasks_add_followers_to_task_request import TasksAddFollowersToTaskRequest
...
from asana_python_sdk.type.tasks_add_followers_to_task_response import TasksAddFollowersToTaskResponse
...
from asana_python_sdk.pydantic.tasks_add_followers_to_task_request import TasksAddFollowersToTaskRequest as TasksAddFollowersToTaskRequestPydantic
from asana_python_sdk.pydantic.tasks_add_followers_to_task_response import TasksAddFollowersToTaskResponse as TasksAddFollowersToTaskResponsePydantic
...
# body param
SchemaForRequestBodyApplicationJson = TasksAddFollowersToTaskRequestSchema


request_body_tasks_add_followers_to_task_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = TasksAddFollowersToTaskResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: TasksAddFollowersToTaskResponse
...
class BaseApi(api_client.Api):
    ...
    def _add_followers_to_task_mapped_args(
        self,
        task_gid: str,
    ...
    async def _aadd_followers_to_task_oapg(
        self,
        ...
        **kwargs,
        ...
        serialized_data = request_body_tasks_add_followers_to_task_request.serialize(body, content_type)
    ...
    def _add_followers_to_task_oapg(
        self,
        body: typing.Any = None,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
...
class AddFollowersToTaskRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aadd_followers_to_task(
        self,
        task_gid: str,
        data: typing.Optional[TaskAddFollowersRequest] = None,
        opt_pretty: typing.Optional[bool] = None,
        ...
        **kwargs,
        ...
        args = self._add_followers_to_task_mapped_args(
            task_gid=task_gid,
            data=data,
            opt_pretty=opt_pretty,
            opt_fields=opt_fields,
        )
        return await self._aadd_followers_to_task_oapg(
            body=args.body,
    ...
    def add_followers_to_task(
        ...
        return self._add_followers_to_task_oapg(
            body=args.body,
            query_params=args.query,
            path_params=args.path,
        )

class AddFollowersToTask(BaseApi):
    ...
    async def aadd_followers_to_task(
        ...
        validate: bool = False,
        **kwargs,
    ) -> TasksAddFollowersToTaskResponsePydantic:
        raw_response = await self.raw.aadd_followers_to_task(
            task_gid=task_gid,
            data=data,
            opt_pretty=opt_pretty,
            opt_fields=opt_fields,
        ...
        if validate:
            return TasksAddFollowersToTaskResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(TasksAddFollowersToTaskResponsePydantic, raw_response.body)
    ...
    def add_followers_to_task(
        ...
        raw_response = self.raw.add_followers_to_task(
            task_gid=task_gid,
            data=data,
            opt_pretty=opt_pretty,
            opt_fields=opt_fields,
