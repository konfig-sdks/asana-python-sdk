...
from asana_python_sdk.model.project_briefs_get_full_record_response import ProjectBriefsGetFullRecordResponse as ProjectBriefsGetFullRecordResponseSchema
from asana_python_sdk.model.error_response import ErrorResponse as ErrorResponseSchema

from asana_python_sdk.type.project_briefs_get_full_record_response import ProjectBriefsGetFullRecordResponse
...
from asana_python_sdk.pydantic.project_briefs_get_full_record_response import ProjectBriefsGetFullRecordResponse as ProjectBriefsGetFullRecordResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = ProjectBriefsGetFullRecordResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ProjectBriefsGetFullRecordResponse
...
class GetFullRecord(BaseApi):
    ...
    async def aget_full_record(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ProjectBriefsGetFullRecordResponsePydantic:
        ...
        if validate:
            return ProjectBriefsGetFullRecordResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(ProjectBriefsGetFullRecordResponsePydantic, raw_response.body)
