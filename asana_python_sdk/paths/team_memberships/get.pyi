...
from asana_python_sdk.model.team_memberships_get_compact_records_response import TeamMembershipsGetCompactRecordsResponse as TeamMembershipsGetCompactRecordsResponseSchema
from asana_python_sdk.model.error_response import ErrorResponse as ErrorResponseSchema

from asana_python_sdk.type.team_memberships_get_compact_records_response import TeamMembershipsGetCompactRecordsResponse
...
from asana_python_sdk.pydantic.team_memberships_get_compact_records_response import TeamMembershipsGetCompactRecordsResponse as TeamMembershipsGetCompactRecordsResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = TeamMembershipsGetCompactRecordsResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: TeamMembershipsGetCompactRecordsResponse
...
class GetCompactRecords(BaseApi):
    ...
    async def aget_compact_records(
        ...
        validate: bool = False,
        **kwargs,
    ) -> TeamMembershipsGetCompactRecordsResponsePydantic:
        ...
        if validate:
            return TeamMembershipsGetCompactRecordsResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(TeamMembershipsGetCompactRecordsResponsePydantic, raw_response.body)
