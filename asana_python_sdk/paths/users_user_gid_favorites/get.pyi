...
from asana_python_sdk.model.users_get_favorites_for_user_response import UsersGetFavoritesForUserResponse as UsersGetFavoritesForUserResponseSchema
from asana_python_sdk.model.error_response import ErrorResponse as ErrorResponseSchema

from asana_python_sdk.type.users_get_favorites_for_user_response import UsersGetFavoritesForUserResponse
...
from asana_python_sdk.pydantic.users_get_favorites_for_user_response import UsersGetFavoritesForUserResponse as UsersGetFavoritesForUserResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = UsersGetFavoritesForUserResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: UsersGetFavoritesForUserResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_favorites_for_user_mapped_args(
        self,
        user_gid: str,
        resource_type: str,
        workspace: str,
        ...
        if resource_type is not None:
            _query_params["resource_type"] = resource_type
    ...
    async def _aget_favorites_for_user_oapg(
        self,
...
class GetFavoritesForUserRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_favorites_for_user(
        self,
        user_gid: str,
        resource_type: str,
        workspace: str,
        ...
        **kwargs,
        ...
        args = self._get_favorites_for_user_mapped_args(
            user_gid=user_gid,
        ...
        return await self._aget_favorites_for_user_oapg(
...
class GetFavoritesForUser(BaseApi):
    ...
    async def aget_favorites_for_user(
        ...
        validate: bool = False,
        **kwargs,
    ) -> UsersGetFavoritesForUserResponsePydantic:
        raw_response = await self.raw.aget_favorites_for_user(
            user_gid=user_gid,
            resource_type=resource_type,
            workspace=workspace,
            opt_pretty=opt_pretty,
        ...
        if validate:
            return UsersGetFavoritesForUserResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(UsersGetFavoritesForUserResponsePydantic, raw_response.body)
    ...
    def get_favorites_for_user(
        ...
        raw_response = self.raw.get_favorites_for_user(
            user_gid=user_gid,
            resource_type=resource_type,
            workspace=workspace,
            opt_pretty=opt_pretty,
