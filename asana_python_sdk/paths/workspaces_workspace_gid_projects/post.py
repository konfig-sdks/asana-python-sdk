...
from asana_python_sdk.model.projects_create_in_workspace_request import ProjectsCreateInWorkspaceRequest as ProjectsCreateInWorkspaceRequestSchema
from asana_python_sdk.model.projects_create_in_workspace_response import ProjectsCreateInWorkspaceResponse as ProjectsCreateInWorkspaceResponseSchema
...
from asana_python_sdk.type.projects_create_in_workspace_response import ProjectsCreateInWorkspaceResponse
...
from asana_python_sdk.type.projects_create_in_workspace_request import ProjectsCreateInWorkspaceRequest
...
from asana_python_sdk.pydantic.projects_create_in_workspace_response import ProjectsCreateInWorkspaceResponse as ProjectsCreateInWorkspaceResponsePydantic
from asana_python_sdk.pydantic.projects_create_in_workspace_request import ProjectsCreateInWorkspaceRequest as ProjectsCreateInWorkspaceRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = ProjectsCreateInWorkspaceRequestSchema


request_body_projects_create_in_workspace_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = ProjectsCreateInWorkspaceResponseSchema


@dataclass
class ApiResponseFor201(api_client.ApiResponse):
    body: ProjectsCreateInWorkspaceResponse
...
class BaseApi(api_client.Api):
    ...
    def _create_in_workspace_mapped_args(
        self,
        workspace_gid: str,
    ...
    async def _acreate_in_workspace_oapg(
        self,
        ...
        **kwargs,
        ...
        serialized_data = request_body_projects_create_in_workspace_request.serialize(body, content_type)
...
class CreateInWorkspaceRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_in_workspace(
        self,
        workspace_gid: str,
        data: typing.Optional[ProjectRequest] = None,
        opt_pretty: typing.Optional[bool] = None,
        ...
        **kwargs,
        ...
        args = self._create_in_workspace_mapped_args(
            workspace_gid=workspace_gid,
            data=data,
            opt_pretty=opt_pretty,
            opt_fields=opt_fields,
        )
        return await self._acreate_in_workspace_oapg(
            body=args.body,
    ...
    def create_in_workspace(
        ...
        return self._create_in_workspace_oapg(
            body=args.body,
            query_params=args.query,
            path_params=args.path,
        )

class CreateInWorkspace(BaseApi):
    ...
    async def acreate_in_workspace(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ProjectsCreateInWorkspaceResponsePydantic:
        raw_response = await self.raw.acreate_in_workspace(
            workspace_gid=workspace_gid,
            data=data,
            opt_pretty=opt_pretty,
            opt_fields=opt_fields,
        ...
        if validate:
            return ProjectsCreateInWorkspaceResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(ProjectsCreateInWorkspaceResponsePydantic, raw_response.body)
    ...
    def create_in_workspace(
        ...
        raw_response = self.raw.create_in_workspace(
            workspace_gid=workspace_gid,
            data=data,
            opt_pretty=opt_pretty,
            opt_fields=opt_fields,
