...
from asana_python_sdk.model.projects_get_all_in_workspace_response import ProjectsGetAllInWorkspaceResponse as ProjectsGetAllInWorkspaceResponseSchema
from asana_python_sdk.model.error_response import ErrorResponse as ErrorResponseSchema

from asana_python_sdk.type.projects_get_all_in_workspace_response import ProjectsGetAllInWorkspaceResponse
...
from asana_python_sdk.pydantic.projects_get_all_in_workspace_response import ProjectsGetAllInWorkspaceResponse as ProjectsGetAllInWorkspaceResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = ProjectsGetAllInWorkspaceResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ProjectsGetAllInWorkspaceResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_all_in_workspace_mapped_args(
        self,
        workspace_gid: str,
    ...
    async def _aget_all_in_workspace_oapg(
        self,
    ...
    def _get_all_in_workspace_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetAllInWorkspaceRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_all_in_workspace(
        self,
        workspace_gid: str,
        opt_pretty: typing.Optional[bool] = None,
        limit: typing.Optional[int] = None,
        ...
        **kwargs,
        ...
        args = self._get_all_in_workspace_mapped_args(
        ...
        return await self._aget_all_in_workspace_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def get_all_in_workspace(
        self,
        workspace_gid: str,
        opt_pretty: typing.Optional[bool] = None,
        limit: typing.Optional[int] = None,
        ...
        return self._get_all_in_workspace_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetAllInWorkspace(BaseApi):
    ...
    async def aget_all_in_workspace(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ProjectsGetAllInWorkspaceResponsePydantic:
        raw_response = await self.raw.aget_all_in_workspace(
            workspace_gid=workspace_gid,
            opt_pretty=opt_pretty,
            limit=limit,
            offset=offset,
        ...
        if validate:
            return ProjectsGetAllInWorkspaceResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(ProjectsGetAllInWorkspaceResponsePydantic, raw_response.body)
    ...
    def get_all_in_workspace(
        ...
        raw_response = self.raw.get_all_in_workspace(
            workspace_gid=workspace_gid,
            opt_pretty=opt_pretty,
            limit=limit,
            offset=offset,
