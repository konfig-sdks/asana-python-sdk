...
from asana_python_sdk.model.workspaces_get_workspace_record_response import WorkspacesGetWorkspaceRecordResponse as WorkspacesGetWorkspaceRecordResponseSchema
...
from asana_python_sdk.type.workspaces_get_workspace_record_response import WorkspacesGetWorkspaceRecordResponse

from ...api_client import Dictionary
from asana_python_sdk.pydantic.error_response import ErrorResponse as ErrorResponsePydantic
from asana_python_sdk.pydantic.workspaces_get_workspace_record_response import WorkspacesGetWorkspaceRecordResponse as WorkspacesGetWorkspaceRecordResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = WorkspacesGetWorkspaceRecordResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: WorkspacesGetWorkspaceRecordResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_workspace_record_mapped_args(
        self,
        workspace_gid: str,
    ...
    async def _aget_workspace_record_oapg(
        self,
    ...
    def _get_workspace_record_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetWorkspaceRecordRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_workspace_record(
        self,
        workspace_gid: str,
        opt_pretty: typing.Optional[bool] = None,
        opt_fields: typing.Optional[typing.List[str]] = None,
        **kwargs,
        ...
        args = self._get_workspace_record_mapped_args(
            workspace_gid=workspace_gid,
            opt_pretty=opt_pretty,
            opt_fields=opt_fields,
        )
        return await self._aget_workspace_record_oapg(
    ...
    def get_workspace_record(
        ...
        return self._get_workspace_record_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetWorkspaceRecord(BaseApi):
    ...
    async def aget_workspace_record(
        ...
        validate: bool = False,
        **kwargs,
    ) -> WorkspacesGetWorkspaceRecordResponsePydantic:
        raw_response = await self.raw.aget_workspace_record(
            workspace_gid=workspace_gid,
            opt_pretty=opt_pretty,
            opt_fields=opt_fields,
            **kwargs,
        ...
        if validate:
            return WorkspacesGetWorkspaceRecordResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(WorkspacesGetWorkspaceRecordResponsePydantic, raw_response.body)
    ...
    def get_workspace_record(
        ...
        raw_response = self.raw.get_workspace_record(
            workspace_gid=workspace_gid,
            opt_pretty=opt_pretty,
            opt_fields=opt_fields,
        )
