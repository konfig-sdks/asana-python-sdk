...
from asana_python_sdk.model.time_tracking_entries_delete_time_entry_response import TimeTrackingEntriesDeleteTimeEntryResponse as TimeTrackingEntriesDeleteTimeEntryResponseSchema
from asana_python_sdk.model.error_response import ErrorResponse as ErrorResponseSchema

from asana_python_sdk.type.time_tracking_entries_delete_time_entry_response import TimeTrackingEntriesDeleteTimeEntryResponse
...
from asana_python_sdk.pydantic.time_tracking_entries_delete_time_entry_response import TimeTrackingEntriesDeleteTimeEntryResponse as TimeTrackingEntriesDeleteTimeEntryResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = TimeTrackingEntriesDeleteTimeEntryResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: TimeTrackingEntriesDeleteTimeEntryResponse
...
class BaseApi(api_client.Api):
    ...
    def _delete_time_entry_mapped_args(
        self,
    ...
    async def _adelete_time_entry_oapg(
        self,
...
class DeleteTimeEntryRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_time_entry(
        self,
        time_tracking_entry_gid: str,
        opt_pretty: typing.Optional[bool] = None,
        **kwargs,
        ...
        args = self._delete_time_entry_mapped_args(
            time_tracking_entry_gid=time_tracking_entry_gid,
            opt_pretty=opt_pretty,
        )
        return await self._adelete_time_entry_oapg(
    ...
    def delete_time_entry(
        ...
        return self._delete_time_entry_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class DeleteTimeEntry(BaseApi):
    ...
    async def adelete_time_entry(
        ...
        validate: bool = False,
        **kwargs,
    ) -> TimeTrackingEntriesDeleteTimeEntryResponsePydantic:
        raw_response = await self.raw.adelete_time_entry(
            time_tracking_entry_gid=time_tracking_entry_gid,
            opt_pretty=opt_pretty,
            **kwargs,
        )
        if validate:
            return TimeTrackingEntriesDeleteTimeEntryResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(TimeTrackingEntriesDeleteTimeEntryResponsePydantic, raw_response.body)
    ...
    def delete_time_entry(
        ...
        raw_response = self.raw.delete_time_entry(
            time_tracking_entry_gid=time_tracking_entry_gid,
            opt_pretty=opt_pretty,
        )
        if validate:
