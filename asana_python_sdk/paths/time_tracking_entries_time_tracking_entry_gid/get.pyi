...
from asana_python_sdk.model.time_tracking_entries_get_record_response import TimeTrackingEntriesGetRecordResponse as TimeTrackingEntriesGetRecordResponseSchema
from asana_python_sdk.model.error_response import ErrorResponse as ErrorResponseSchema

from asana_python_sdk.type.time_tracking_entries_get_record_response import TimeTrackingEntriesGetRecordResponse
...
from asana_python_sdk.pydantic.time_tracking_entries_get_record_response import TimeTrackingEntriesGetRecordResponse as TimeTrackingEntriesGetRecordResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = TimeTrackingEntriesGetRecordResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: TimeTrackingEntriesGetRecordResponse
...
class GetRecord(BaseApi):
    ...
    async def aget_record(
        ...
        validate: bool = False,
        **kwargs,
    ) -> TimeTrackingEntriesGetRecordResponsePydantic:
        ...
        if validate:
            return TimeTrackingEntriesGetRecordResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(TimeTrackingEntriesGetRecordResponsePydantic, raw_response.body)
