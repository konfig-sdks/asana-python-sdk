...
from asana_python_sdk.model.tasks_get_all_dependencies_response import TasksGetAllDependenciesResponse as TasksGetAllDependenciesResponseSchema
from asana_python_sdk.model.error_response import ErrorResponse as ErrorResponseSchema

from asana_python_sdk.type.tasks_get_all_dependencies_response import TasksGetAllDependenciesResponse
...
from asana_python_sdk.pydantic.tasks_get_all_dependencies_response import TasksGetAllDependenciesResponse as TasksGetAllDependenciesResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = TasksGetAllDependenciesResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: TasksGetAllDependenciesResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_all_dependencies_mapped_args(
        self,
        task_gid: str,
    ...
    async def _aget_all_dependencies_oapg(
        self,
    ...
    def _get_all_dependencies_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetAllDependenciesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_all_dependencies(
        self,
        task_gid: str,
        opt_pretty: typing.Optional[bool] = None,
        limit: typing.Optional[int] = None,
        ...
        **kwargs,
        ...
        args = self._get_all_dependencies_mapped_args(
            task_gid=task_gid,
        ...
        return await self._aget_all_dependencies_oapg(
    ...
    def get_all_dependencies(
        ...
        return self._get_all_dependencies_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetAllDependencies(BaseApi):
    ...
    async def aget_all_dependencies(
        ...
        validate: bool = False,
        **kwargs,
    ) -> TasksGetAllDependenciesResponsePydantic:
        raw_response = await self.raw.aget_all_dependencies(
            task_gid=task_gid,
            opt_pretty=opt_pretty,
            limit=limit,
            offset=offset,
        ...
        if validate:
            return TasksGetAllDependenciesResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(TasksGetAllDependenciesResponsePydantic, raw_response.body)
    ...
    def get_all_dependencies(
        ...
        raw_response = self.raw.get_all_dependencies(
            task_gid=task_gid,
            opt_pretty=opt_pretty,
            limit=limit,
            offset=offset,
