...
from asana_python_sdk.model.projects_get_task_counts_response import ProjectsGetTaskCountsResponse as ProjectsGetTaskCountsResponseSchema
from asana_python_sdk.model.error_response import ErrorResponse as ErrorResponseSchema

from asana_python_sdk.type.projects_get_task_counts_response import ProjectsGetTaskCountsResponse
...
from asana_python_sdk.pydantic.projects_get_task_counts_response import ProjectsGetTaskCountsResponse as ProjectsGetTaskCountsResponsePydantic
        ...
        class items(
            ...
            class MetaOapg:
                enum_value_to_name = {
                    ...
                    "num_incomplete_milestones": "INCOMPLETE_MILESTONES",
                    "num_incomplete_tasks": "INCOMPLETE_TASKS",
                    "num_milestones": "MILESTONES",
                    "num_tasks": "TASKS",
                }
            
            @schemas.classproperty
            def COMPLETED_MILESTONES(cls):
                return cls("num_completed_milestones")
            
            @schemas.classproperty
            def COMPLETED_TASKS(cls):
                return cls("num_completed_tasks")
            
            @schemas.classproperty
            def INCOMPLETE_MILESTONES(cls):
                return cls("num_incomplete_milestones")
            
            @schemas.classproperty
            def INCOMPLETE_TASKS(cls):
                return cls("num_incomplete_tasks")
            
            @schemas.classproperty
            def MILESTONES(cls):
                return cls("num_milestones")
            
            @schemas.classproperty
            def TASKS(cls):
                return cls("num_tasks")
...
SchemaFor200ResponseBodyApplicationJson = ProjectsGetTaskCountsResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ProjectsGetTaskCountsResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_task_counts_mapped_args(
        self,
        project_gid: str,
    ...
    async def _aget_task_counts_oapg(
        self,
...
class GetTaskCountsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_task_counts(
        self,
        project_gid: str,
        opt_pretty: typing.Optional[bool] = None,
        opt_fields: typing.Optional[typing.List[str]] = None,
        **kwargs,
        ...
        args = self._get_task_counts_mapped_args(
            project_gid=project_gid,
            opt_pretty=opt_pretty,
            opt_fields=opt_fields,
        )
        return await self._aget_task_counts_oapg(
    ...
    def get_task_counts(
        ...
        return self._get_task_counts_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetTaskCounts(BaseApi):
    ...
    async def aget_task_counts(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ProjectsGetTaskCountsResponsePydantic:
        raw_response = await self.raw.aget_task_counts(
            project_gid=project_gid,
            opt_pretty=opt_pretty,
            opt_fields=opt_fields,
            **kwargs,
        ...
        if validate:
            return ProjectsGetTaskCountsResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(ProjectsGetTaskCountsResponsePydantic, raw_response.body)
    ...
    def get_task_counts(
        ...
        raw_response = self.raw.get_task_counts(
            project_gid=project_gid,
            opt_pretty=opt_pretty,
            opt_fields=opt_fields,
        )
