...
from asana_python_sdk.model.projects_list_multiple_response import ProjectsListMultipleResponse as ProjectsListMultipleResponseSchema
from asana_python_sdk.model.error_response import ErrorResponse as ErrorResponseSchema

from asana_python_sdk.type.projects_list_multiple_response import ProjectsListMultipleResponse
...
from asana_python_sdk.pydantic.projects_list_multiple_response import ProjectsListMultipleResponse as ProjectsListMultipleResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = ProjectsListMultipleResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ProjectsListMultipleResponse
...
class ListMultiple(BaseApi):
    ...
    async def alist_multiple(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ProjectsListMultipleResponsePydantic:
        ...
        if validate:
            return ProjectsListMultipleResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(ProjectsListMultipleResponsePydantic, raw_response.body)
