...
from asana_python_sdk.model.project_templates_list_multiple_response import ProjectTemplatesListMultipleResponse as ProjectTemplatesListMultipleResponseSchema
from asana_python_sdk.model.error_response import ErrorResponse as ErrorResponseSchema

from asana_python_sdk.type.project_templates_list_multiple_response import ProjectTemplatesListMultipleResponse
...
from asana_python_sdk.pydantic.project_templates_list_multiple_response import ProjectTemplatesListMultipleResponse as ProjectTemplatesListMultipleResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = ProjectTemplatesListMultipleResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ProjectTemplatesListMultipleResponse
...
class BaseApi(api_client.Api):
    ...
    def _list_multiple_mapped_args(
        self,
    ...
    async def _alist_multiple_oapg(
        self,
...
class ListMultipleRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_multiple(
        self,
        opt_pretty: typing.Optional[bool] = None,
        workspace: typing.Optional[str] = None,
        team: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._list_multiple_mapped_args(
        ...
        return await self._alist_multiple_oapg(
    ...
    def list_multiple(
        ...
        return self._list_multiple_oapg(
            query_params=args.query,
        )

class ListMultiple(BaseApi):
    ...
    async def alist_multiple(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ProjectTemplatesListMultipleResponsePydantic:
        raw_response = await self.raw.alist_multiple(
            opt_pretty=opt_pretty,
            workspace=workspace,
            team=team,
            limit=limit,
        ...
        if validate:
            return ProjectTemplatesListMultipleResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(ProjectTemplatesListMultipleResponsePydantic, raw_response.body)
    ...
    def list_multiple(
        ...
        raw_response = self.raw.list_multiple(
            opt_pretty=opt_pretty,
            workspace=workspace,
            team=team,
            limit=limit,
