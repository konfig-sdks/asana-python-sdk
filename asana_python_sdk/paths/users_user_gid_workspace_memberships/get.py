...
from asana_python_sdk.model.workspace_memberships_get_user_memberships_response import WorkspaceMembershipsGetUserMembershipsResponse as WorkspaceMembershipsGetUserMembershipsResponseSchema
from asana_python_sdk.model.error_response import ErrorResponse as ErrorResponseSchema

from asana_python_sdk.type.workspace_memberships_get_user_memberships_response import WorkspaceMembershipsGetUserMembershipsResponse
...
from asana_python_sdk.pydantic.workspace_memberships_get_user_memberships_response import WorkspaceMembershipsGetUserMembershipsResponse as WorkspaceMembershipsGetUserMembershipsResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = WorkspaceMembershipsGetUserMembershipsResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: WorkspaceMembershipsGetUserMembershipsResponse
...
class GetUserMemberships(BaseApi):
    ...
    async def aget_user_memberships(
        ...
        validate: bool = False,
        **kwargs,
    ) -> WorkspaceMembershipsGetUserMembershipsResponsePydantic:
        ...
        if validate:
            return WorkspaceMembershipsGetUserMembershipsResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(WorkspaceMembershipsGetUserMembershipsResponsePydantic, raw_response.body)
