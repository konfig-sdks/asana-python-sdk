...
from asana_python_sdk.model.teams_create_team_record_response import TeamsCreateTeamRecordResponse as TeamsCreateTeamRecordResponseSchema
from asana_python_sdk.model.teams_create_team_record_request import TeamsCreateTeamRecordRequest as TeamsCreateTeamRecordRequestSchema
...
from asana_python_sdk.type.teams_create_team_record_response import TeamsCreateTeamRecordResponse
from asana_python_sdk.type.teams_create_team_record_request import TeamsCreateTeamRecordRequest

from ...api_client import Dictionary
from asana_python_sdk.pydantic.teams_create_team_record_response import TeamsCreateTeamRecordResponse as TeamsCreateTeamRecordResponsePydantic
from asana_python_sdk.pydantic.error_response import ErrorResponse as ErrorResponsePydantic
from asana_python_sdk.pydantic.teams_create_team_record_request import TeamsCreateTeamRecordRequest as TeamsCreateTeamRecordRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = TeamsCreateTeamRecordRequestSchema


request_body_teams_create_team_record_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = TeamsCreateTeamRecordResponseSchema


@dataclass
class ApiResponseFor201(api_client.ApiResponse):
    body: TeamsCreateTeamRecordResponse
...
class BaseApi(api_client.Api):
    ...
    def _create_team_record_mapped_args(
        self,
    ...
    async def _acreate_team_record_oapg(
        self,
        ...
        **kwargs,
        ...
        serialized_data = request_body_teams_create_team_record_request.serialize(body, content_type)
...
class CreateTeamRecordRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_team_record(
        self,
        data: typing.Optional[TeamRequest] = None,
        opt_pretty: typing.Optional[bool] = None,
        opt_fields: typing.Optional[typing.List[str]] = None,
        **kwargs,
        ...
        args = self._create_team_record_mapped_args(
            data=data,
            opt_pretty=opt_pretty,
            opt_fields=opt_fields,
        )
        return await self._acreate_team_record_oapg(
            body=args.body,
    ...
    def create_team_record(
        ...
        return self._create_team_record_oapg(
            body=args.body,
            query_params=args.query,
        )

class CreateTeamRecord(BaseApi):
    ...
    async def acreate_team_record(
        ...
        validate: bool = False,
        **kwargs,
    ) -> TeamsCreateTeamRecordResponsePydantic:
        raw_response = await self.raw.acreate_team_record(
            data=data,
            opt_pretty=opt_pretty,
            opt_fields=opt_fields,
            **kwargs,
        ...
        if validate:
            return TeamsCreateTeamRecordResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(TeamsCreateTeamRecordResponsePydantic, raw_response.body)
    ...
    def create_team_record(
        ...
        raw_response = self.raw.create_team_record(
            data=data,
            opt_pretty=opt_pretty,
            opt_fields=opt_fields,
        )
