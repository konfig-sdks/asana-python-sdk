...
from asana_python_sdk.model.tags_update_tag_record_response import TagsUpdateTagRecordResponse as TagsUpdateTagRecordResponseSchema
from asana_python_sdk.model.error_response import ErrorResponse as ErrorResponseSchema

from asana_python_sdk.type.tags_update_tag_record_response import TagsUpdateTagRecordResponse
from asana_python_sdk.type.error_response import ErrorResponse

from ...api_client import Dictionary
from asana_python_sdk.pydantic.tags_update_tag_record_response import TagsUpdateTagRecordResponse as TagsUpdateTagRecordResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = TagsUpdateTagRecordResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: TagsUpdateTagRecordResponse
...
class BaseApi(api_client.Api):
    ...
    def _update_tag_record_mapped_args(
        self,
        tag_gid: str,
    ...
    async def _aupdate_tag_record_oapg(
        self,
...
class UpdateTagRecordRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_tag_record(
        self,
        tag_gid: str,
        opt_pretty: typing.Optional[bool] = None,
        opt_fields: typing.Optional[typing.List[str]] = None,
        **kwargs,
        ...
        args = self._update_tag_record_mapped_args(
            tag_gid=tag_gid,
            opt_pretty=opt_pretty,
            opt_fields=opt_fields,
        )
        return await self._aupdate_tag_record_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def update_tag_record(
        self,
        tag_gid: str,
        opt_pretty: typing.Optional[bool] = None,
        opt_fields: typing.Optional[typing.List[str]] = None,
        ...
        return self._update_tag_record_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class UpdateTagRecord(BaseApi):
    ...
    async def aupdate_tag_record(
        ...
        validate: bool = False,
        **kwargs,
    ) -> TagsUpdateTagRecordResponsePydantic:
        raw_response = await self.raw.aupdate_tag_record(
            tag_gid=tag_gid,
            opt_pretty=opt_pretty,
            opt_fields=opt_fields,
            **kwargs,
        ...
        if validate:
            return TagsUpdateTagRecordResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(TagsUpdateTagRecordResponsePydantic, raw_response.body)
    ...
    def update_tag_record(
        ...
        raw_response = self.raw.update_tag_record(
            tag_gid=tag_gid,
            opt_pretty=opt_pretty,
            opt_fields=opt_fields,
        )
