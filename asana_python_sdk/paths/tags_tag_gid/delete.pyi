...
from asana_python_sdk.model.tags_remove_tag_response import TagsRemoveTagResponse as TagsRemoveTagResponseSchema
...
from asana_python_sdk.type.tags_remove_tag_response import TagsRemoveTagResponse

from ...api_client import Dictionary
from asana_python_sdk.pydantic.error_response import ErrorResponse as ErrorResponsePydantic
from asana_python_sdk.pydantic.tags_remove_tag_response import TagsRemoveTagResponse as TagsRemoveTagResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = TagsRemoveTagResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: TagsRemoveTagResponse
...
class RemoveTag(BaseApi):
    ...
    async def aremove_tag(
        ...
        **kwargs,
        ...
        if validate:
            return TagsRemoveTagResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(TagsRemoveTagResponsePydantic, raw_response.body)
