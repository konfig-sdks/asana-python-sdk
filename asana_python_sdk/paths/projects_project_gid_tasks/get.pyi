...
from asana_python_sdk.model.tasks_get_tasks_by_project_response import TasksGetTasksByProjectResponse as TasksGetTasksByProjectResponseSchema
from asana_python_sdk.model.error_response import ErrorResponse as ErrorResponseSchema

from asana_python_sdk.type.tasks_get_tasks_by_project_response import TasksGetTasksByProjectResponse
from asana_python_sdk.type.error_response import ErrorResponse

from ...api_client import Dictionary
from asana_python_sdk.pydantic.tasks_get_tasks_by_project_response import TasksGetTasksByProjectResponse as TasksGetTasksByProjectResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = TasksGetTasksByProjectResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: TasksGetTasksByProjectResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_tasks_by_project_mapped_args(
        self,
        project_gid: str,
    ...
    async def _aget_tasks_by_project_oapg(
        self,
    ...
    def _get_tasks_by_project_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetTasksByProjectRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_tasks_by_project(
        self,
        project_gid: str,
        completed_since: typing.Optional[str] = None,
        opt_pretty: typing.Optional[bool] = None,
        ...
        **kwargs,
        ...
        args = self._get_tasks_by_project_mapped_args(
        ...
        return await self._aget_tasks_by_project_oapg(
    ...
    def get_tasks_by_project(
        ...
        return self._get_tasks_by_project_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetTasksByProject(BaseApi):
    ...
    async def aget_tasks_by_project(
        ...
        validate: bool = False,
        **kwargs,
    ) -> TasksGetTasksByProjectResponsePydantic:
        raw_response = await self.raw.aget_tasks_by_project(
            project_gid=project_gid,
            completed_since=completed_since,
            opt_pretty=opt_pretty,
            limit=limit,
        ...
        if validate:
            return TasksGetTasksByProjectResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(TasksGetTasksByProjectResponsePydantic, raw_response.body)
    ...
    def get_tasks_by_project(
        ...
        raw_response = self.raw.get_tasks_by_project(
            project_gid=project_gid,
            completed_since=completed_since,
            opt_pretty=opt_pretty,
            limit=limit,
