...
from asana_python_sdk.model.tags_get_filtered_tags_response import TagsGetFilteredTagsResponse as TagsGetFilteredTagsResponseSchema
from asana_python_sdk.model.error_response import ErrorResponse as ErrorResponseSchema

from asana_python_sdk.type.tags_get_filtered_tags_response import TagsGetFilteredTagsResponse
...
from asana_python_sdk.pydantic.tags_get_filtered_tags_response import TagsGetFilteredTagsResponse as TagsGetFilteredTagsResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = TagsGetFilteredTagsResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: TagsGetFilteredTagsResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_filtered_tags_mapped_args(
        self,
        workspace_gid: str,
    ...
    async def _aget_filtered_tags_oapg(
        self,
...
class GetFilteredTagsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_filtered_tags(
        self,
        workspace_gid: str,
        opt_pretty: typing.Optional[bool] = None,
        limit: typing.Optional[int] = None,
        ...
        **kwargs,
        ...
        args = self._get_filtered_tags_mapped_args(
        ...
        return await self._aget_filtered_tags_oapg(
    ...
    def get_filtered_tags(
        ...
        return self._get_filtered_tags_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetFilteredTags(BaseApi):
    ...
    async def aget_filtered_tags(
        ...
        validate: bool = False,
        **kwargs,
    ) -> TagsGetFilteredTagsResponsePydantic:
        raw_response = await self.raw.aget_filtered_tags(
            workspace_gid=workspace_gid,
            opt_pretty=opt_pretty,
            limit=limit,
            offset=offset,
        ...
        if validate:
            return TagsGetFilteredTagsResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(TagsGetFilteredTagsResponsePydantic, raw_response.body)
    ...
    def get_filtered_tags(
        ...
        raw_response = self.raw.get_filtered_tags(
            workspace_gid=workspace_gid,
            opt_pretty=opt_pretty,
            limit=limit,
            offset=offset,
