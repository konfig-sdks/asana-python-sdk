...
from asana_python_sdk.model.project_templates_get_record_response import ProjectTemplatesGetRecordResponse as ProjectTemplatesGetRecordResponseSchema
from asana_python_sdk.model.error_response import ErrorResponse as ErrorResponseSchema

from asana_python_sdk.type.project_templates_get_record_response import ProjectTemplatesGetRecordResponse
...
from asana_python_sdk.pydantic.project_templates_get_record_response import ProjectTemplatesGetRecordResponse as ProjectTemplatesGetRecordResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = ProjectTemplatesGetRecordResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ProjectTemplatesGetRecordResponse
...
class GetRecord(BaseApi):
    ...
    async def aget_record(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ProjectTemplatesGetRecordResponsePydantic:
        ...
        if validate:
            return ProjectTemplatesGetRecordResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(ProjectTemplatesGetRecordResponsePydantic, raw_response.body)
