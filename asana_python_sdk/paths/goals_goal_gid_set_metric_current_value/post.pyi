...
from asana_python_sdk.model.goal_metric_current_value_request import GoalMetricCurrentValueRequest as GoalMetricCurrentValueRequestSchema
from asana_python_sdk.model.goals_update_metric_current_value_request import GoalsUpdateMetricCurrentValueRequest as GoalsUpdateMetricCurrentValueRequestSchema
from asana_python_sdk.model.goals_update_metric_current_value_response import GoalsUpdateMetricCurrentValueResponse as GoalsUpdateMetricCurrentValueResponseSchema
from asana_python_sdk.model.error_response import ErrorResponse as ErrorResponseSchema

from asana_python_sdk.type.goals_update_metric_current_value_response import GoalsUpdateMetricCurrentValueResponse
from asana_python_sdk.type.goals_update_metric_current_value_request import GoalsUpdateMetricCurrentValueRequest
...
from asana_python_sdk.pydantic.goals_update_metric_current_value_request import GoalsUpdateMetricCurrentValueRequest as GoalsUpdateMetricCurrentValueRequestPydantic
from asana_python_sdk.pydantic.error_response import ErrorResponse as ErrorResponsePydantic
from asana_python_sdk.pydantic.goal_metric_current_value_request import GoalMetricCurrentValueRequest as GoalMetricCurrentValueRequestPydantic
from asana_python_sdk.pydantic.goals_update_metric_current_value_response import GoalsUpdateMetricCurrentValueResponse as GoalsUpdateMetricCurrentValueResponsePydantic
...
# body param
SchemaForRequestBodyApplicationJson = GoalsUpdateMetricCurrentValueRequestSchema


request_body_goals_update_metric_current_value_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = GoalsUpdateMetricCurrentValueResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: GoalsUpdateMetricCurrentValueResponse
...
class BaseApi(api_client.Api):
    ...
    def _update_metric_current_value_mapped_args(
        self,
        goal_gid: str,
        data: typing.Optional[GoalMetricCurrentValueRequest] = None,
    ...
    async def _aupdate_metric_current_value_oapg(
        self,
        ...
        **kwargs,
        ...
        serialized_data = request_body_goals_update_metric_current_value_request.serialize(body, content_type)
    ...
    def _update_metric_current_value_oapg(
        self,
        body: typing.Any = None,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
...
class UpdateMetricCurrentValueRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_metric_current_value(
        self,
        goal_gid: str,
        data: typing.Optional[GoalMetricCurrentValueRequest] = None,
        opt_pretty: typing.Optional[bool] = None,
        ...
        **kwargs,
        ...
        args = self._update_metric_current_value_mapped_args(
            goal_gid=goal_gid,
            data=data,
            opt_pretty=opt_pretty,
            opt_fields=opt_fields,
        )
        return await self._aupdate_metric_current_value_oapg(
            body=args.body,
    ...
    def update_metric_current_value(
        self,
        goal_gid: str,
        data: typing.Optional[GoalMetricCurrentValueRequest] = None,
        opt_pretty: typing.Optional[bool] = None,
        ...
        return self._update_metric_current_value_oapg(
            body=args.body,
            query_params=args.query,
            path_params=args.path,
        )

class UpdateMetricCurrentValue(BaseApi):
    ...
    async def aupdate_metric_current_value(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GoalsUpdateMetricCurrentValueResponsePydantic:
        raw_response = await self.raw.aupdate_metric_current_value(
            goal_gid=goal_gid,
            data=data,
            opt_pretty=opt_pretty,
            opt_fields=opt_fields,
        ...
        if validate:
            return GoalsUpdateMetricCurrentValueResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(GoalsUpdateMetricCurrentValueResponsePydantic, raw_response.body)
    ...
    def update_metric_current_value(
        ...
        raw_response = self.raw.update_metric_current_value(
            goal_gid=goal_gid,
            data=data,
            opt_pretty=opt_pretty,
            opt_fields=opt_fields,
