...
from asana_python_sdk.model.goals_create_new_goal_record_request import GoalsCreateNewGoalRecordRequest as GoalsCreateNewGoalRecordRequestSchema
from asana_python_sdk.model.goal_request import GoalRequest as GoalRequestSchema
from asana_python_sdk.model.goals_create_new_goal_record_response import GoalsCreateNewGoalRecordResponse as GoalsCreateNewGoalRecordResponseSchema
from asana_python_sdk.model.error_response import ErrorResponse as ErrorResponseSchema

from asana_python_sdk.type.goals_create_new_goal_record_response import GoalsCreateNewGoalRecordResponse
from asana_python_sdk.type.goal_request import GoalRequest
from asana_python_sdk.type.goals_create_new_goal_record_request import GoalsCreateNewGoalRecordRequest
...
from asana_python_sdk.pydantic.goals_create_new_goal_record_request import GoalsCreateNewGoalRecordRequest as GoalsCreateNewGoalRecordRequestPydantic
from asana_python_sdk.pydantic.goals_create_new_goal_record_response import GoalsCreateNewGoalRecordResponse as GoalsCreateNewGoalRecordResponsePydantic
from asana_python_sdk.pydantic.goal_request import GoalRequest as GoalRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = GoalsCreateNewGoalRecordRequestSchema


request_body_goals_create_new_goal_record_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = GoalsCreateNewGoalRecordResponseSchema


@dataclass
class ApiResponseFor201(api_client.ApiResponse):
    body: GoalsCreateNewGoalRecordResponse
...
class BaseApi(api_client.Api):
    ...
    def _create_new_goal_record_mapped_args(
        self,
        data: typing.Optional[GoalRequest] = None,
    ...
    async def _acreate_new_goal_record_oapg(
        self,
        ...
        **kwargs,
        ...
        serialized_data = request_body_goals_create_new_goal_record_request.serialize(body, content_type)
    ...
    def _create_new_goal_record_oapg(
        self,
        body: typing.Any = None,
            query_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class CreateNewGoalRecordRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_new_goal_record(
        self,
        data: typing.Optional[GoalRequest] = None,
        opt_pretty: typing.Optional[bool] = None,
        opt_fields: typing.Optional[typing.List[str]] = None,
        **kwargs,
        ...
        args = self._create_new_goal_record_mapped_args(
            data=data,
            opt_pretty=opt_pretty,
            opt_fields=opt_fields,
        )
        return await self._acreate_new_goal_record_oapg(
            body=args.body,
            query_params=args.query,
            **kwargs,
        )
    
    def create_new_goal_record(
        self,
        data: typing.Optional[GoalRequest] = None,
        opt_pretty: typing.Optional[bool] = None,
        opt_fields: typing.Optional[typing.List[str]] = None,
        ...
        return self._create_new_goal_record_oapg(
            body=args.body,
            query_params=args.query,
        )

class CreateNewGoalRecord(BaseApi):
    ...
    async def acreate_new_goal_record(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GoalsCreateNewGoalRecordResponsePydantic:
        raw_response = await self.raw.acreate_new_goal_record(
            data=data,
            opt_pretty=opt_pretty,
            opt_fields=opt_fields,
            **kwargs,
        ...
        if validate:
            return GoalsCreateNewGoalRecordResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(GoalsCreateNewGoalRecordResponsePydantic, raw_response.body)
    ...
    def create_new_goal_record(
        ...
        raw_response = self.raw.create_new_goal_record(
            data=data,
            opt_pretty=opt_pretty,
            opt_fields=opt_fields,
        )
