...
from asana_python_sdk.model.goals_add_collaborators_to_goal_request import GoalsAddCollaboratorsToGoalRequest as GoalsAddCollaboratorsToGoalRequestSchema
from asana_python_sdk.model.goals_add_collaborators_to_goal_response import GoalsAddCollaboratorsToGoalResponse as GoalsAddCollaboratorsToGoalResponseSchema
...
from asana_python_sdk.type.goals_add_collaborators_to_goal_response import GoalsAddCollaboratorsToGoalResponse
from asana_python_sdk.type.task_add_followers_request import TaskAddFollowersRequest
from asana_python_sdk.type.goals_add_collaborators_to_goal_request import GoalsAddCollaboratorsToGoalRequest
from asana_python_sdk.type.error_response import ErrorResponse

from ...api_client import Dictionary
from asana_python_sdk.pydantic.goals_add_collaborators_to_goal_request import GoalsAddCollaboratorsToGoalRequest as GoalsAddCollaboratorsToGoalRequestPydantic
...
from asana_python_sdk.pydantic.goals_add_collaborators_to_goal_response import GoalsAddCollaboratorsToGoalResponse as GoalsAddCollaboratorsToGoalResponsePydantic
...
# body param
SchemaForRequestBodyApplicationJson = GoalsAddCollaboratorsToGoalRequestSchema


request_body_goals_add_collaborators_to_goal_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = GoalsAddCollaboratorsToGoalResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: GoalsAddCollaboratorsToGoalResponse
...
class BaseApi(api_client.Api):
    ...
    def _add_collaborators_to_goal_mapped_args(
        self,
        goal_gid: str,
    ...
    async def _aadd_collaborators_to_goal_oapg(
        self,
        ...
        **kwargs,
        ...
        serialized_data = request_body_goals_add_collaborators_to_goal_request.serialize(body, content_type)
    ...
    def _add_collaborators_to_goal_oapg(
        self,
        body: typing.Any = None,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
...
class AddCollaboratorsToGoalRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aadd_collaborators_to_goal(
        self,
        goal_gid: str,
        data: typing.Optional[TaskAddFollowersRequest] = None,
        opt_pretty: typing.Optional[bool] = None,
        ...
        **kwargs,
        ...
        args = self._add_collaborators_to_goal_mapped_args(
            goal_gid=goal_gid,
            data=data,
            opt_pretty=opt_pretty,
            opt_fields=opt_fields,
        )
        return await self._aadd_collaborators_to_goal_oapg(
            body=args.body,
    ...
    def add_collaborators_to_goal(
        ...
        return self._add_collaborators_to_goal_oapg(
            body=args.body,
            query_params=args.query,
            path_params=args.path,
        )

class AddCollaboratorsToGoal(BaseApi):
    ...
    async def aadd_collaborators_to_goal(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GoalsAddCollaboratorsToGoalResponsePydantic:
        raw_response = await self.raw.aadd_collaborators_to_goal(
            goal_gid=goal_gid,
            data=data,
            opt_pretty=opt_pretty,
            opt_fields=opt_fields,
        ...
        if validate:
            return GoalsAddCollaboratorsToGoalResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(GoalsAddCollaboratorsToGoalResponsePydantic, raw_response.body)
    ...
    def add_collaborators_to_goal(
        ...
        raw_response = self.raw.add_collaborators_to_goal(
            goal_gid=goal_gid,
            data=data,
            opt_pretty=opt_pretty,
            opt_fields=opt_fields,
