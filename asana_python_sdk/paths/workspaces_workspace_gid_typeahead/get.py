...
from asana_python_sdk.model.typeahead_get_results_response import TypeaheadGetResultsResponse as TypeaheadGetResultsResponseSchema
from asana_python_sdk.model.error_response import ErrorResponse as ErrorResponseSchema

from asana_python_sdk.type.typeahead_get_results_response import TypeaheadGetResultsResponse
...
from asana_python_sdk.pydantic.typeahead_get_results_response import TypeaheadGetResultsResponse as TypeaheadGetResultsResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = TypeaheadGetResultsResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: TypeaheadGetResultsResponse
...
class GetResults(BaseApi):
    ...
    async def aget_results(
        ...
        validate: bool = False,
        **kwargs,
    ) -> TypeaheadGetResultsResponsePydantic:
        ...
        if validate:
            return TypeaheadGetResultsResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(TypeaheadGetResultsResponsePydantic, raw_response.body)
