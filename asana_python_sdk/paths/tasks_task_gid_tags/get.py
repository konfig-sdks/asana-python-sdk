...
from asana_python_sdk.model.tags_get_task_tags_response import TagsGetTaskTagsResponse as TagsGetTaskTagsResponseSchema
from asana_python_sdk.model.error_response import ErrorResponse as ErrorResponseSchema

from asana_python_sdk.type.tags_get_task_tags_response import TagsGetTaskTagsResponse
...
from asana_python_sdk.pydantic.tags_get_task_tags_response import TagsGetTaskTagsResponse as TagsGetTaskTagsResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = TagsGetTaskTagsResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: TagsGetTaskTagsResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_task_tags_mapped_args(
        self,
        task_gid: str,
    ...
    async def _aget_task_tags_oapg(
        self,
...
class GetTaskTagsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_task_tags(
        self,
        task_gid: str,
        opt_pretty: typing.Optional[bool] = None,
        limit: typing.Optional[int] = None,
        ...
        **kwargs,
        ...
        args = self._get_task_tags_mapped_args(
            task_gid=task_gid,
        ...
        return await self._aget_task_tags_oapg(
    ...
    def get_task_tags(
        ...
        return self._get_task_tags_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetTaskTags(BaseApi):
    ...
    async def aget_task_tags(
        ...
        validate: bool = False,
        **kwargs,
    ) -> TagsGetTaskTagsResponsePydantic:
        raw_response = await self.raw.aget_task_tags(
            task_gid=task_gid,
            opt_pretty=opt_pretty,
            limit=limit,
            offset=offset,
        ...
        if validate:
            return TagsGetTaskTagsResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(TagsGetTaskTagsResponsePydantic, raw_response.body)
    ...
    def get_task_tags(
        ...
        raw_response = self.raw.get_task_tags(
            task_gid=task_gid,
            opt_pretty=opt_pretty,
            limit=limit,
            offset=offset,
