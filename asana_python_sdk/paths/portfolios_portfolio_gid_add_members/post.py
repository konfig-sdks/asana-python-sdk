...
from asana_python_sdk.model.portfolios_add_members_to_portfolio_request import PortfoliosAddMembersToPortfolioRequest as PortfoliosAddMembersToPortfolioRequestSchema
from asana_python_sdk.model.portfolios_add_members_to_portfolio_response import PortfoliosAddMembersToPortfolioResponse as PortfoliosAddMembersToPortfolioResponseSchema
from asana_python_sdk.model.add_members_request import AddMembersRequest as AddMembersRequestSchema
from asana_python_sdk.model.error_response import ErrorResponse as ErrorResponseSchema

from asana_python_sdk.type.portfolios_add_members_to_portfolio_response import PortfoliosAddMembersToPortfolioResponse
from asana_python_sdk.type.add_members_request import AddMembersRequest
from asana_python_sdk.type.portfolios_add_members_to_portfolio_request import PortfoliosAddMembersToPortfolioRequest
from asana_python_sdk.type.error_response import ErrorResponse

from ...api_client import Dictionary
from asana_python_sdk.pydantic.portfolios_add_members_to_portfolio_response import PortfoliosAddMembersToPortfolioResponse as PortfoliosAddMembersToPortfolioResponsePydantic
from asana_python_sdk.pydantic.error_response import ErrorResponse as ErrorResponsePydantic
from asana_python_sdk.pydantic.portfolios_add_members_to_portfolio_request import PortfoliosAddMembersToPortfolioRequest as PortfoliosAddMembersToPortfolioRequestPydantic
from asana_python_sdk.pydantic.add_members_request import AddMembersRequest as AddMembersRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = PortfoliosAddMembersToPortfolioRequestSchema


request_body_portfolios_add_members_to_portfolio_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = PortfoliosAddMembersToPortfolioResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: PortfoliosAddMembersToPortfolioResponse
...
class BaseApi(api_client.Api):
    ...
    def _add_members_to_portfolio_mapped_args(
        self,
        portfolio_gid: str,
        data: typing.Optional[AddMembersRequest] = None,
    ...
    async def _aadd_members_to_portfolio_oapg(
        self,
        ...
        **kwargs,
        ...
        serialized_data = request_body_portfolios_add_members_to_portfolio_request.serialize(body, content_type)
    ...
    def _add_members_to_portfolio_oapg(
        self,
        body: typing.Any = None,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
...
class AddMembersToPortfolioRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aadd_members_to_portfolio(
        self,
        portfolio_gid: str,
        data: typing.Optional[AddMembersRequest] = None,
        opt_pretty: typing.Optional[bool] = None,
        ...
        **kwargs,
        ...
        args = self._add_members_to_portfolio_mapped_args(
            portfolio_gid=portfolio_gid,
            data=data,
            opt_pretty=opt_pretty,
            opt_fields=opt_fields,
        )
        return await self._aadd_members_to_portfolio_oapg(
            body=args.body,
    ...
    def add_members_to_portfolio(
        ...
        return self._add_members_to_portfolio_oapg(
            body=args.body,
            query_params=args.query,
            path_params=args.path,
        )

class AddMembersToPortfolio(BaseApi):
    ...
    async def aadd_members_to_portfolio(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PortfoliosAddMembersToPortfolioResponsePydantic:
        raw_response = await self.raw.aadd_members_to_portfolio(
            portfolio_gid=portfolio_gid,
            data=data,
            opt_pretty=opt_pretty,
            opt_fields=opt_fields,
        ...
        if validate:
            return PortfoliosAddMembersToPortfolioResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(PortfoliosAddMembersToPortfolioResponsePydantic, raw_response.body)
    ...
    def add_members_to_portfolio(
        ...
        raw_response = self.raw.add_members_to_portfolio(
            portfolio_gid=portfolio_gid,
            data=data,
            opt_pretty=opt_pretty,
            opt_fields=opt_fields,
