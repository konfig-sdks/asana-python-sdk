...
from asana_python_sdk.model.goals_create_metric_response import GoalsCreateMetricResponse as GoalsCreateMetricResponseSchema
from asana_python_sdk.model.goal_metric_base import GoalMetricBase as GoalMetricBaseSchema
from asana_python_sdk.model.goals_create_metric_request import GoalsCreateMetricRequest as GoalsCreateMetricRequestSchema
from asana_python_sdk.model.error_response import ErrorResponse as ErrorResponseSchema

from asana_python_sdk.type.goals_create_metric_request import GoalsCreateMetricRequest
from asana_python_sdk.type.goal_metric_base import GoalMetricBase
from asana_python_sdk.type.goals_create_metric_response import GoalsCreateMetricResponse
from asana_python_sdk.type.error_response import ErrorResponse

from ...api_client import Dictionary
from asana_python_sdk.pydantic.goals_create_metric_request import GoalsCreateMetricRequest as GoalsCreateMetricRequestPydantic
from asana_python_sdk.pydantic.error_response import ErrorResponse as ErrorResponsePydantic
from asana_python_sdk.pydantic.goal_metric_base import GoalMetricBase as GoalMetricBasePydantic
from asana_python_sdk.pydantic.goals_create_metric_response import GoalsCreateMetricResponse as GoalsCreateMetricResponsePydantic
...
# body param
SchemaForRequestBodyApplicationJson = GoalsCreateMetricRequestSchema


request_body_goals_create_metric_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = GoalsCreateMetricResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: GoalsCreateMetricResponse
...
class BaseApi(api_client.Api):
    ...
    def _create_metric_mapped_args(
        self,
        goal_gid: str,
        data: typing.Optional[GoalMetricBase] = None,
    ...
    async def _acreate_metric_oapg(
        self,
        ...
        **kwargs,
        ...
        serialized_data = request_body_goals_create_metric_request.serialize(body, content_type)
...
class CreateMetricRaw(BaseApi):
    ...
    async def acreate_metric(
        ...
        **kwargs,
        ...
        args = self._create_metric_mapped_args(
            goal_gid=goal_gid,
            data=data,
            opt_pretty=opt_pretty,
            opt_fields=opt_fields,
        )
        return await self._acreate_metric_oapg(
            body=args.body,
    ...
    def create_metric(
        ...
        return self._create_metric_oapg(
            body=args.body,
            query_params=args.query,
            path_params=args.path,
        )

class CreateMetric(BaseApi):
    ...
    async def acreate_metric(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GoalsCreateMetricResponsePydantic:
        raw_response = await self.raw.acreate_metric(
            goal_gid=goal_gid,
            data=data,
            opt_pretty=opt_pretty,
            opt_fields=opt_fields,
        ...
        if validate:
            return GoalsCreateMetricResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(GoalsCreateMetricResponsePydantic, raw_response.body)
    ...
    def create_metric(
        ...
        raw_response = self.raw.create_metric(
            goal_gid=goal_gid,
            data=data,
            opt_pretty=opt_pretty,
            opt_fields=opt_fields,
