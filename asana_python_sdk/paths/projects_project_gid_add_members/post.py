...
from asana_python_sdk.model.projects_add_members_to_project_response import ProjectsAddMembersToProjectResponse as ProjectsAddMembersToProjectResponseSchema
from asana_python_sdk.model.add_members_request import AddMembersRequest as AddMembersRequestSchema
from asana_python_sdk.model.projects_add_members_to_project_request import ProjectsAddMembersToProjectRequest as ProjectsAddMembersToProjectRequestSchema
...
from asana_python_sdk.type.projects_add_members_to_project_response import ProjectsAddMembersToProjectResponse
from asana_python_sdk.type.error_response import ErrorResponse
from asana_python_sdk.type.projects_add_members_to_project_request import ProjectsAddMembersToProjectRequest
...
from asana_python_sdk.pydantic.projects_add_members_to_project_response import ProjectsAddMembersToProjectResponse as ProjectsAddMembersToProjectResponsePydantic
from asana_python_sdk.pydantic.projects_add_members_to_project_request import ProjectsAddMembersToProjectRequest as ProjectsAddMembersToProjectRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = ProjectsAddMembersToProjectRequestSchema


request_body_projects_add_members_to_project_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ProjectsAddMembersToProjectResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ProjectsAddMembersToProjectResponse
...
class BaseApi(api_client.Api):
    ...
    def _add_members_to_project_mapped_args(
        self,
        project_gid: str,
    ...
    async def _aadd_members_to_project_oapg(
        self,
        ...
        **kwargs,
        ...
        serialized_data = request_body_projects_add_members_to_project_request.serialize(body, content_type)
    ...
    def _add_members_to_project_oapg(
        self,
        body: typing.Any = None,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
...
class AddMembersToProjectRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aadd_members_to_project(
        self,
        project_gid: str,
        data: typing.Optional[AddMembersRequest] = None,
        opt_pretty: typing.Optional[bool] = None,
        ...
        **kwargs,
        ...
        args = self._add_members_to_project_mapped_args(
            project_gid=project_gid,
            data=data,
            opt_pretty=opt_pretty,
            opt_fields=opt_fields,
        )
        return await self._aadd_members_to_project_oapg(
            body=args.body,
    ...
    def add_members_to_project(
        ...
        return self._add_members_to_project_oapg(
            body=args.body,
            query_params=args.query,
            path_params=args.path,
        )

class AddMembersToProject(BaseApi):
    ...
    async def aadd_members_to_project(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ProjectsAddMembersToProjectResponsePydantic:
        raw_response = await self.raw.aadd_members_to_project(
            project_gid=project_gid,
            data=data,
            opt_pretty=opt_pretty,
            opt_fields=opt_fields,
        ...
        if validate:
            return ProjectsAddMembersToProjectResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(ProjectsAddMembersToProjectResponsePydantic, raw_response.body)
    ...
    def add_members_to_project(
        ...
        raw_response = self.raw.add_members_to_project(
            project_gid=project_gid,
            data=data,
            opt_pretty=opt_pretty,
            opt_fields=opt_fields,
