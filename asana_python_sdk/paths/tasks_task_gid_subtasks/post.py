...
from asana_python_sdk.model.tasks_create_subtask_record_request import TasksCreateSubtaskRecordRequest as TasksCreateSubtaskRecordRequestSchema
from asana_python_sdk.model.tasks_create_subtask_record_response import TasksCreateSubtaskRecordResponse as TasksCreateSubtaskRecordResponseSchema
from asana_python_sdk.model.task_request import TaskRequest as TaskRequestSchema
from asana_python_sdk.model.error_response import ErrorResponse as ErrorResponseSchema

from asana_python_sdk.type.tasks_create_subtask_record_request import TasksCreateSubtaskRecordRequest
from asana_python_sdk.type.tasks_create_subtask_record_response import TasksCreateSubtaskRecordResponse
from asana_python_sdk.type.task_request import TaskRequest
from asana_python_sdk.type.error_response import ErrorResponse

from ...api_client import Dictionary
from asana_python_sdk.pydantic.tasks_create_subtask_record_response import TasksCreateSubtaskRecordResponse as TasksCreateSubtaskRecordResponsePydantic
from asana_python_sdk.pydantic.task_request import TaskRequest as TaskRequestPydantic
from asana_python_sdk.pydantic.error_response import ErrorResponse as ErrorResponsePydantic
from asana_python_sdk.pydantic.tasks_create_subtask_record_request import TasksCreateSubtaskRecordRequest as TasksCreateSubtaskRecordRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = TasksCreateSubtaskRecordRequestSchema


request_body_tasks_create_subtask_record_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = TasksCreateSubtaskRecordResponseSchema


@dataclass
class ApiResponseFor201(api_client.ApiResponse):
    body: TasksCreateSubtaskRecordResponse
...
class BaseApi(api_client.Api):
    ...
    def _create_subtask_record_mapped_args(
        self,
        task_gid: str,
        data: typing.Optional[TaskRequest] = None,
    ...
    async def _acreate_subtask_record_oapg(
        self,
        ...
        **kwargs,
        ...
        serialized_data = request_body_tasks_create_subtask_record_request.serialize(body, content_type)
    ...
    def _create_subtask_record_oapg(
        self,
        body: typing.Any = None,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
...
class CreateSubtaskRecordRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_subtask_record(
        self,
        task_gid: str,
        data: typing.Optional[TaskRequest] = None,
        opt_pretty: typing.Optional[bool] = None,
        ...
        **kwargs,
        ...
        args = self._create_subtask_record_mapped_args(
            task_gid=task_gid,
            data=data,
            opt_pretty=opt_pretty,
            opt_fields=opt_fields,
        )
        return await self._acreate_subtask_record_oapg(
            body=args.body,
    ...
    def create_subtask_record(
        ...
        return self._create_subtask_record_oapg(
            body=args.body,
            query_params=args.query,
            path_params=args.path,
        )

class CreateSubtaskRecord(BaseApi):
    ...
    async def acreate_subtask_record(
        ...
        validate: bool = False,
        **kwargs,
    ) -> TasksCreateSubtaskRecordResponsePydantic:
        raw_response = await self.raw.acreate_subtask_record(
            task_gid=task_gid,
            data=data,
            opt_pretty=opt_pretty,
            opt_fields=opt_fields,
        ...
        if validate:
            return TasksCreateSubtaskRecordResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(TasksCreateSubtaskRecordResponsePydantic, raw_response.body)
    ...
    def create_subtask_record(
        ...
        raw_response = self.raw.create_subtask_record(
            task_gid=task_gid,
            data=data,
            opt_pretty=opt_pretty,
            opt_fields=opt_fields,
