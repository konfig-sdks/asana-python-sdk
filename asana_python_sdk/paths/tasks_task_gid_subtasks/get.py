...
from asana_python_sdk.model.tasks_get_subtask_list_response import TasksGetSubtaskListResponse as TasksGetSubtaskListResponseSchema
from asana_python_sdk.model.error_response import ErrorResponse as ErrorResponseSchema

from asana_python_sdk.type.tasks_get_subtask_list_response import TasksGetSubtaskListResponse
...
from asana_python_sdk.pydantic.tasks_get_subtask_list_response import TasksGetSubtaskListResponse as TasksGetSubtaskListResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = TasksGetSubtaskListResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: TasksGetSubtaskListResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_subtask_list_mapped_args(
        self,
        task_gid: str,
    ...
    async def _aget_subtask_list_oapg(
        self,
...
class GetSubtaskListRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_subtask_list(
        self,
        task_gid: str,
        opt_pretty: typing.Optional[bool] = None,
        limit: typing.Optional[int] = None,
        ...
        **kwargs,
        ...
        args = self._get_subtask_list_mapped_args(
            task_gid=task_gid,
        ...
        return await self._aget_subtask_list_oapg(
    ...
    def get_subtask_list(
        ...
        return self._get_subtask_list_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetSubtaskList(BaseApi):
    ...
    async def aget_subtask_list(
        ...
        validate: bool = False,
        **kwargs,
    ) -> TasksGetSubtaskListResponsePydantic:
        raw_response = await self.raw.aget_subtask_list(
            task_gid=task_gid,
            opt_pretty=opt_pretty,
            limit=limit,
            offset=offset,
        ...
        if validate:
            return TasksGetSubtaskListResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(TasksGetSubtaskListResponsePydantic, raw_response.body)
    ...
    def get_subtask_list(
        ...
        raw_response = self.raw.get_subtask_list(
            task_gid=task_gid,
            opt_pretty=opt_pretty,
            limit=limit,
            offset=offset,
