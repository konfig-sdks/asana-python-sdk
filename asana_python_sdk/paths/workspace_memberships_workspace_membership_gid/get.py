...
from asana_python_sdk.model.workspace_memberships_get_record_by_id_response import WorkspaceMembershipsGetRecordByIdResponse as WorkspaceMembershipsGetRecordByIdResponseSchema
from asana_python_sdk.model.error_response import ErrorResponse as ErrorResponseSchema

from asana_python_sdk.type.workspace_memberships_get_record_by_id_response import WorkspaceMembershipsGetRecordByIdResponse
...
from asana_python_sdk.pydantic.workspace_memberships_get_record_by_id_response import WorkspaceMembershipsGetRecordByIdResponse as WorkspaceMembershipsGetRecordByIdResponsePydantic
        ...
        class items(
            ...
            class MetaOapg:
                enum_value_to_name = {
                    ...
                    "user_task_list.name": "USER_TASK_LIST_NAME",
                    "user_task_list.owner": "USER_TASK_LIST_OWNER",
                    "user_task_list.workspace": "USER_TASK_LIST_WORKSPACE",
                    "vacation_dates": "VACATION_DATES",
                    "vacation_dates.end_on": "VACATION_DATES_END_ON",
                    "vacation_dates.start_on": "VACATION_DATES_START_ON",
                    "workspace": "WORKSPACE",
...
SchemaFor200ResponseBodyApplicationJson = WorkspaceMembershipsGetRecordByIdResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: WorkspaceMembershipsGetRecordByIdResponse
...
class GetRecordById(BaseApi):
    ...
    async def aget_record_by_id(
        ...
        validate: bool = False,
        **kwargs,
    ) -> WorkspaceMembershipsGetRecordByIdResponsePydantic:
        ...
        if validate:
            return WorkspaceMembershipsGetRecordByIdResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(WorkspaceMembershipsGetRecordByIdResponsePydantic, raw_response.body)
