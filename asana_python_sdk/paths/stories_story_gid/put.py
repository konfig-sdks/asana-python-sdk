...
from asana_python_sdk.model.stories_update_full_record_response import StoriesUpdateFullRecordResponse as StoriesUpdateFullRecordResponseSchema
from asana_python_sdk.model.stories_update_full_record_request import StoriesUpdateFullRecordRequest as StoriesUpdateFullRecordRequestSchema
from asana_python_sdk.model.story_base import StoryBase as StoryBaseSchema
from asana_python_sdk.model.error_response import ErrorResponse as ErrorResponseSchema

from asana_python_sdk.type.stories_update_full_record_response import StoriesUpdateFullRecordResponse
from asana_python_sdk.type.stories_update_full_record_request import StoriesUpdateFullRecordRequest
...
from asana_python_sdk.pydantic.stories_update_full_record_request import StoriesUpdateFullRecordRequest as StoriesUpdateFullRecordRequestPydantic
from asana_python_sdk.pydantic.story_base import StoryBase as StoryBasePydantic
from asana_python_sdk.pydantic.stories_update_full_record_response import StoriesUpdateFullRecordResponse as StoriesUpdateFullRecordResponsePydantic
...
# body param
SchemaForRequestBodyApplicationJson = StoriesUpdateFullRecordRequestSchema


request_body_stories_update_full_record_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = StoriesUpdateFullRecordResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: StoriesUpdateFullRecordResponse
...
class BaseApi(api_client.Api):
    ...
    def _update_full_record_mapped_args(
        self,
        story_gid: str,
        data: typing.Optional[StoryBase] = None,
    ...
    async def _aupdate_full_record_oapg(
        self,
        ...
        **kwargs,
        ...
        serialized_data = request_body_stories_update_full_record_request.serialize(body, content_type)
...
class UpdateFullRecordRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_full_record(
        self,
        story_gid: str,
        data: typing.Optional[StoryBase] = None,
        opt_pretty: typing.Optional[bool] = None,
        ...
        **kwargs,
        ...
        args = self._update_full_record_mapped_args(
            story_gid=story_gid,
            data=data,
            opt_pretty=opt_pretty,
            opt_fields=opt_fields,
        )
        return await self._aupdate_full_record_oapg(
            body=args.body,
    ...
    def update_full_record(
        ...
        return self._update_full_record_oapg(
            body=args.body,
            query_params=args.query,
            path_params=args.path,
        )

class UpdateFullRecord(BaseApi):
    ...
    async def aupdate_full_record(
        ...
        validate: bool = False,
        **kwargs,
    ) -> StoriesUpdateFullRecordResponsePydantic:
        raw_response = await self.raw.aupdate_full_record(
            story_gid=story_gid,
            data=data,
            opt_pretty=opt_pretty,
            opt_fields=opt_fields,
        ...
        if validate:
            return StoriesUpdateFullRecordResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(StoriesUpdateFullRecordResponsePydantic, raw_response.body)
    ...
    def update_full_record(
        ...
        raw_response = self.raw.update_full_record(
            story_gid=story_gid,
            data=data,
            opt_pretty=opt_pretty,
            opt_fields=opt_fields,
