...
from asana_python_sdk.model.stories_delete_story_record_response import StoriesDeleteStoryRecordResponse as StoriesDeleteStoryRecordResponseSchema
from asana_python_sdk.model.error_response import ErrorResponse as ErrorResponseSchema

from asana_python_sdk.type.stories_delete_story_record_response import StoriesDeleteStoryRecordResponse
...
from asana_python_sdk.pydantic.stories_delete_story_record_response import StoriesDeleteStoryRecordResponse as StoriesDeleteStoryRecordResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = StoriesDeleteStoryRecordResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: StoriesDeleteStoryRecordResponse
...
class BaseApi(api_client.Api):
    ...
    def _delete_story_record_mapped_args(
        self,
        story_gid: str,
    ...
    async def _adelete_story_record_oapg(
        self,
...
class DeleteStoryRecordRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_story_record(
        self,
        story_gid: str,
        opt_pretty: typing.Optional[bool] = None,
        **kwargs,
        ...
        args = self._delete_story_record_mapped_args(
            story_gid=story_gid,
            opt_pretty=opt_pretty,
        )
        return await self._adelete_story_record_oapg(
    ...
    def delete_story_record(
        ...
        return self._delete_story_record_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class DeleteStoryRecord(BaseApi):
    ...
    async def adelete_story_record(
        ...
        validate: bool = False,
        **kwargs,
    ) -> StoriesDeleteStoryRecordResponsePydantic:
        raw_response = await self.raw.adelete_story_record(
            story_gid=story_gid,
            opt_pretty=opt_pretty,
            **kwargs,
        )
        if validate:
            return StoriesDeleteStoryRecordResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(StoriesDeleteStoryRecordResponsePydantic, raw_response.body)
    ...
    def delete_story_record(
        ...
        raw_response = self.raw.delete_story_record(
            story_gid=story_gid,
            opt_pretty=opt_pretty,
        )
        if validate:
