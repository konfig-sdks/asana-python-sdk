...
from asana_python_sdk.model.time_tracking_entries_get_for_task_response import TimeTrackingEntriesGetForTaskResponse as TimeTrackingEntriesGetForTaskResponseSchema
from asana_python_sdk.model.error_response import ErrorResponse as ErrorResponseSchema

from asana_python_sdk.type.time_tracking_entries_get_for_task_response import TimeTrackingEntriesGetForTaskResponse
...
from asana_python_sdk.pydantic.time_tracking_entries_get_for_task_response import TimeTrackingEntriesGetForTaskResponse as TimeTrackingEntriesGetForTaskResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = TimeTrackingEntriesGetForTaskResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: TimeTrackingEntriesGetForTaskResponse
...
class GetForTaskRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_for_task(
        self,
        task_gid: str,
        opt_pretty: typing.Optional[bool] = None,
        limit: typing.Optional[int] = None,
        ...
        **kwargs,
        ...
        args = self._get_for_task_mapped_args(
            task_gid=task_gid,
        ...
        return await self._aget_for_task_oapg(
    ...
    def get_for_task(
        ...
        return self._get_for_task_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetForTask(BaseApi):
    ...
    async def aget_for_task(
        ...
        validate: bool = False,
        **kwargs,
    ) -> TimeTrackingEntriesGetForTaskResponsePydantic:
        raw_response = await self.raw.aget_for_task(
            task_gid=task_gid,
            opt_pretty=opt_pretty,
            limit=limit,
            offset=offset,
        ...
        if validate:
            return TimeTrackingEntriesGetForTaskResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(TimeTrackingEntriesGetForTaskResponsePydantic, raw_response.body)
    ...
    def get_for_task(
        ...
        raw_response = self.raw.get_for_task(
            task_gid=task_gid,
            opt_pretty=opt_pretty,
            limit=limit,
            offset=offset,
