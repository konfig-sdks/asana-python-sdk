...
from asana_python_sdk.model.projects_add_followers_to_project_response import ProjectsAddFollowersToProjectResponse as ProjectsAddFollowersToProjectResponseSchema
from asana_python_sdk.model.projects_add_followers_to_project_request import ProjectsAddFollowersToProjectRequest as ProjectsAddFollowersToProjectRequestSchema
from asana_python_sdk.model.add_followers_request import AddFollowersRequest as AddFollowersRequestSchema
from asana_python_sdk.model.error_response import ErrorResponse as ErrorResponseSchema

from asana_python_sdk.type.add_followers_request import AddFollowersRequest
from asana_python_sdk.type.projects_add_followers_to_project_response import ProjectsAddFollowersToProjectResponse
from asana_python_sdk.type.error_response import ErrorResponse
from asana_python_sdk.type.projects_add_followers_to_project_request import ProjectsAddFollowersToProjectRequest

from ...api_client import Dictionary
from asana_python_sdk.pydantic.projects_add_followers_to_project_response import ProjectsAddFollowersToProjectResponse as ProjectsAddFollowersToProjectResponsePydantic
from asana_python_sdk.pydantic.error_response import ErrorResponse as ErrorResponsePydantic
from asana_python_sdk.pydantic.projects_add_followers_to_project_request import ProjectsAddFollowersToProjectRequest as ProjectsAddFollowersToProjectRequestPydantic
from asana_python_sdk.pydantic.add_followers_request import AddFollowersRequest as AddFollowersRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = ProjectsAddFollowersToProjectRequestSchema


request_body_projects_add_followers_to_project_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ProjectsAddFollowersToProjectResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ProjectsAddFollowersToProjectResponse
...
class BaseApi(api_client.Api):
    ...
    def _add_followers_to_project_mapped_args(
        self,
        project_gid: str,
        data: typing.Optional[AddFollowersRequest] = None,
    ...
    async def _aadd_followers_to_project_oapg(
        self,
        ...
        **kwargs,
        ...
        serialized_data = request_body_projects_add_followers_to_project_request.serialize(body, content_type)
    ...
    def _add_followers_to_project_oapg(
        self,
        body: typing.Any = None,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
...
class AddFollowersToProjectRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aadd_followers_to_project(
        self,
        project_gid: str,
        data: typing.Optional[AddFollowersRequest] = None,
        opt_pretty: typing.Optional[bool] = None,
        ...
        **kwargs,
        ...
        args = self._add_followers_to_project_mapped_args(
            project_gid=project_gid,
            data=data,
            opt_pretty=opt_pretty,
            opt_fields=opt_fields,
        )
        return await self._aadd_followers_to_project_oapg(
            body=args.body,
    ...
    def add_followers_to_project(
        ...
        return self._add_followers_to_project_oapg(
            body=args.body,
            query_params=args.query,
            path_params=args.path,
        )

class AddFollowersToProject(BaseApi):
    ...
    async def aadd_followers_to_project(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ProjectsAddFollowersToProjectResponsePydantic:
        raw_response = await self.raw.aadd_followers_to_project(
            project_gid=project_gid,
            data=data,
            opt_pretty=opt_pretty,
            opt_fields=opt_fields,
        ...
        if validate:
            return ProjectsAddFollowersToProjectResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(ProjectsAddFollowersToProjectResponsePydantic, raw_response.body)
    ...
    def add_followers_to_project(
        ...
        raw_response = self.raw.add_followers_to_project(
            project_gid=project_gid,
            data=data,
            opt_pretty=opt_pretty,
            opt_fields=opt_fields,
