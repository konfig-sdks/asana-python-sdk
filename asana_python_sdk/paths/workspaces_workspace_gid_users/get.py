...
from asana_python_sdk.model.users_list_workspace_users_response import UsersListWorkspaceUsersResponse as UsersListWorkspaceUsersResponseSchema
from asana_python_sdk.model.error_response import ErrorResponse as ErrorResponseSchema

from asana_python_sdk.type.users_list_workspace_users_response import UsersListWorkspaceUsersResponse
...
from asana_python_sdk.pydantic.users_list_workspace_users_response import UsersListWorkspaceUsersResponse as UsersListWorkspaceUsersResponsePydantic
        ...
        class items(
            ...
            class MetaOapg:
                enum_value_to_name = {
                    ...
                    "name": "NAME",
                    "photo": "PHOTO",
                    "photo.image_1024x1024": "PHOTO_IMAGE_1024X1024",
                    "photo.image_128x128": "PHOTO_IMAGE_128X128",
                    "photo.image_21x21": "PHOTO_IMAGE_21X21",
                    "photo.image_27x27": "PHOTO_IMAGE_27X27",
                    "photo.image_36x36": "PHOTO_IMAGE_36X36",
                    "photo.image_60x60": "PHOTO_IMAGE_60X60",
                    "workspaces": "WORKSPACES",
                    "workspaces.name": "WORKSPACES_NAME",
                }
...
SchemaFor200ResponseBodyApplicationJson = UsersListWorkspaceUsersResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: UsersListWorkspaceUsersResponse
...
class BaseApi(api_client.Api):
    ...
    def _list_workspace_users_mapped_args(
        self,
        workspace_gid: str,
    ...
    async def _alist_workspace_users_oapg(
        self,
    ...
    def _list_workspace_users_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class ListWorkspaceUsersRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_workspace_users(
        self,
        workspace_gid: str,
        opt_pretty: typing.Optional[bool] = None,
        offset: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._list_workspace_users_mapped_args(
            workspace_gid=workspace_gid,
            opt_pretty=opt_pretty,
            offset=offset,
            opt_fields=opt_fields,
        )
        return await self._alist_workspace_users_oapg(
    ...
    def list_workspace_users(
        ...
        return self._list_workspace_users_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class ListWorkspaceUsers(BaseApi):
    ...
    async def alist_workspace_users(
        ...
        validate: bool = False,
        **kwargs,
    ) -> UsersListWorkspaceUsersResponsePydantic:
        raw_response = await self.raw.alist_workspace_users(
            workspace_gid=workspace_gid,
            opt_pretty=opt_pretty,
            offset=offset,
            opt_fields=opt_fields,
        ...
        if validate:
            return UsersListWorkspaceUsersResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(UsersListWorkspaceUsersResponsePydantic, raw_response.body)
    ...
    def list_workspace_users(
        ...
        raw_response = self.raw.list_workspace_users(
            workspace_gid=workspace_gid,
            opt_pretty=opt_pretty,
            offset=offset,
            opt_fields=opt_fields,
