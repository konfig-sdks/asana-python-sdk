...
from asana_python_sdk.model.teams_list_workspace_teams_response import TeamsListWorkspaceTeamsResponse as TeamsListWorkspaceTeamsResponseSchema
...
from asana_python_sdk.type.teams_list_workspace_teams_response import TeamsListWorkspaceTeamsResponse

from ...api_client import Dictionary
from asana_python_sdk.pydantic.error_response import ErrorResponse as ErrorResponsePydantic
from asana_python_sdk.pydantic.teams_list_workspace_teams_response import TeamsListWorkspaceTeamsResponse as TeamsListWorkspaceTeamsResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = TeamsListWorkspaceTeamsResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: TeamsListWorkspaceTeamsResponse
...
class BaseApi(api_client.Api):
    ...
    def _list_workspace_teams_mapped_args(
        self,
        workspace_gid: str,
    ...
    async def _alist_workspace_teams_oapg(
        self,
    ...
    def _list_workspace_teams_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class ListWorkspaceTeamsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_workspace_teams(
        self,
        workspace_gid: str,
        opt_pretty: typing.Optional[bool] = None,
        limit: typing.Optional[int] = None,
        ...
        **kwargs,
        ...
        args = self._list_workspace_teams_mapped_args(
        ...
        return await self._alist_workspace_teams_oapg(
    ...
    def list_workspace_teams(
        ...
        return self._list_workspace_teams_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class ListWorkspaceTeams(BaseApi):
    ...
    async def alist_workspace_teams(
        ...
        validate: bool = False,
        **kwargs,
    ) -> TeamsListWorkspaceTeamsResponsePydantic:
        raw_response = await self.raw.alist_workspace_teams(
            workspace_gid=workspace_gid,
            opt_pretty=opt_pretty,
            limit=limit,
            offset=offset,
        ...
        if validate:
            return TeamsListWorkspaceTeamsResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(TeamsListWorkspaceTeamsResponsePydantic, raw_response.body)
    ...
    def list_workspace_teams(
        ...
        raw_response = self.raw.list_workspace_teams(
            workspace_gid=workspace_gid,
            opt_pretty=opt_pretty,
            limit=limit,
            offset=offset,
