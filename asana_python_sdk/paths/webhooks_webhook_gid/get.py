...
from asana_python_sdk.model.webhooks_get_webhook_record_response import WebhooksGetWebhookRecordResponse as WebhooksGetWebhookRecordResponseSchema
from asana_python_sdk.model.error_response import ErrorResponse as ErrorResponseSchema

from asana_python_sdk.type.webhooks_get_webhook_record_response import WebhooksGetWebhookRecordResponse
...
from asana_python_sdk.pydantic.webhooks_get_webhook_record_response import WebhooksGetWebhookRecordResponse as WebhooksGetWebhookRecordResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = WebhooksGetWebhookRecordResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: WebhooksGetWebhookRecordResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_webhook_record_mapped_args(
        self,
        webhook_gid: str,
    ...
    async def _aget_webhook_record_oapg(
        self,
...
class GetWebhookRecordRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_webhook_record(
        self,
        webhook_gid: str,
        opt_pretty: typing.Optional[bool] = None,
        opt_fields: typing.Optional[typing.List[str]] = None,
        **kwargs,
        ...
        args = self._get_webhook_record_mapped_args(
            webhook_gid=webhook_gid,
            opt_pretty=opt_pretty,
            opt_fields=opt_fields,
        )
        return await self._aget_webhook_record_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def get_webhook_record(
        self,
        webhook_gid: str,
        opt_pretty: typing.Optional[bool] = None,
        opt_fields: typing.Optional[typing.List[str]] = None,
        ...
        return self._get_webhook_record_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetWebhookRecord(BaseApi):
    ...
    async def aget_webhook_record(
        ...
        validate: bool = False,
        **kwargs,
    ) -> WebhooksGetWebhookRecordResponsePydantic:
        raw_response = await self.raw.aget_webhook_record(
            webhook_gid=webhook_gid,
            opt_pretty=opt_pretty,
            opt_fields=opt_fields,
            **kwargs,
        ...
        if validate:
            return WebhooksGetWebhookRecordResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(WebhooksGetWebhookRecordResponsePydantic, raw_response.body)
    ...
    def get_webhook_record(
        ...
        raw_response = self.raw.get_webhook_record(
            webhook_gid=webhook_gid,
            opt_pretty=opt_pretty,
            opt_fields=opt_fields,
        )
