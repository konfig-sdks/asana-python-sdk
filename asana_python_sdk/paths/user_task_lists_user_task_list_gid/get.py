...
from asana_python_sdk.model.user_task_lists_get_record_response import UserTaskListsGetRecordResponse as UserTaskListsGetRecordResponseSchema
from asana_python_sdk.model.error_response import ErrorResponse as ErrorResponseSchema

from asana_python_sdk.type.user_task_lists_get_record_response import UserTaskListsGetRecordResponse
from asana_python_sdk.type.error_response import ErrorResponse

from ...api_client import Dictionary
from asana_python_sdk.pydantic.user_task_lists_get_record_response import UserTaskListsGetRecordResponse as UserTaskListsGetRecordResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = UserTaskListsGetRecordResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: UserTaskListsGetRecordResponse
...
class GetRecord(BaseApi):
    ...
    async def aget_record(
        ...
        validate: bool = False,
        **kwargs,
    ) -> UserTaskListsGetRecordResponsePydantic:
        ...
        if validate:
            return UserTaskListsGetRecordResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(UserTaskListsGetRecordResponsePydantic, raw_response.body)
