...
from asana_python_sdk.model.user_task_lists_get_user_task_list_response import UserTaskListsGetUserTaskListResponse as UserTaskListsGetUserTaskListResponseSchema
...
from asana_python_sdk.type.user_task_lists_get_user_task_list_response import UserTaskListsGetUserTaskListResponse

from ...api_client import Dictionary
from asana_python_sdk.pydantic.error_response import ErrorResponse as ErrorResponsePydantic
from asana_python_sdk.pydantic.user_task_lists_get_user_task_list_response import UserTaskListsGetUserTaskListResponse as UserTaskListsGetUserTaskListResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = UserTaskListsGetUserTaskListResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: UserTaskListsGetUserTaskListResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_user_task_list_mapped_args(
        self,
        user_gid: str,
        workspace: str,
    ...
    async def _aget_user_task_list_oapg(
        self,
...
class GetUserTaskListRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_user_task_list(
        self,
        user_gid: str,
        workspace: str,
        opt_pretty: typing.Optional[bool] = None,
        ...
        **kwargs,
        ...
        args = self._get_user_task_list_mapped_args(
            user_gid=user_gid,
            workspace=workspace,
            opt_pretty=opt_pretty,
            opt_fields=opt_fields,
        )
        return await self._aget_user_task_list_oapg(
...
class GetUserTaskList(BaseApi):
    ...
    async def aget_user_task_list(
        ...
        validate: bool = False,
        **kwargs,
    ) -> UserTaskListsGetUserTaskListResponsePydantic:
        raw_response = await self.raw.aget_user_task_list(
            user_gid=user_gid,
            workspace=workspace,
            opt_pretty=opt_pretty,
            opt_fields=opt_fields,
        ...
        if validate:
            return UserTaskListsGetUserTaskListResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(UserTaskListsGetUserTaskListResponsePydantic, raw_response.body)
    ...
    def get_user_task_list(
        ...
        raw_response = self.raw.get_user_task_list(
            user_gid=user_gid,
            workspace=workspace,
            opt_pretty=opt_pretty,
            opt_fields=opt_fields,
