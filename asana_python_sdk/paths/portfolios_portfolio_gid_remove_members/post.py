...
from asana_python_sdk.model.portfolios_remove_members_from_portfolio_request import PortfoliosRemoveMembersFromPortfolioRequest as PortfoliosRemoveMembersFromPortfolioRequestSchema
from asana_python_sdk.model.remove_members_request import RemoveMembersRequest as RemoveMembersRequestSchema
from asana_python_sdk.model.portfolios_remove_members_from_portfolio_response import PortfoliosRemoveMembersFromPortfolioResponse as PortfoliosRemoveMembersFromPortfolioResponseSchema
from asana_python_sdk.model.error_response import ErrorResponse as ErrorResponseSchema

from asana_python_sdk.type.portfolios_remove_members_from_portfolio_request import PortfoliosRemoveMembersFromPortfolioRequest
from asana_python_sdk.type.remove_members_request import RemoveMembersRequest
from asana_python_sdk.type.portfolios_remove_members_from_portfolio_response import PortfoliosRemoveMembersFromPortfolioResponse
from asana_python_sdk.type.error_response import ErrorResponse

from ...api_client import Dictionary
from asana_python_sdk.pydantic.portfolios_remove_members_from_portfolio_request import PortfoliosRemoveMembersFromPortfolioRequest as PortfoliosRemoveMembersFromPortfolioRequestPydantic
from asana_python_sdk.pydantic.portfolios_remove_members_from_portfolio_response import PortfoliosRemoveMembersFromPortfolioResponse as PortfoliosRemoveMembersFromPortfolioResponsePydantic
from asana_python_sdk.pydantic.remove_members_request import RemoveMembersRequest as RemoveMembersRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = PortfoliosRemoveMembersFromPortfolioRequestSchema


request_body_portfolios_remove_members_from_portfolio_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = PortfoliosRemoveMembersFromPortfolioResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: PortfoliosRemoveMembersFromPortfolioResponse
...
class BaseApi(api_client.Api):
    ...
    def _remove_members_from_portfolio_mapped_args(
        self,
        portfolio_gid: str,
        data: typing.Optional[RemoveMembersRequest] = None,
    ...
    async def _aremove_members_from_portfolio_oapg(
        self,
        ...
        **kwargs,
        ...
        serialized_data = request_body_portfolios_remove_members_from_portfolio_request.serialize(body, content_type)
    ...
    def _remove_members_from_portfolio_oapg(
        self,
        body: typing.Any = None,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
...
class RemoveMembersFromPortfolioRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aremove_members_from_portfolio(
        self,
        portfolio_gid: str,
        data: typing.Optional[RemoveMembersRequest] = None,
        opt_pretty: typing.Optional[bool] = None,
        ...
        **kwargs,
        ...
        args = self._remove_members_from_portfolio_mapped_args(
            portfolio_gid=portfolio_gid,
            data=data,
            opt_pretty=opt_pretty,
            opt_fields=opt_fields,
        )
        return await self._aremove_members_from_portfolio_oapg(
            body=args.body,
    ...
    def remove_members_from_portfolio(
        self,
        portfolio_gid: str,
        data: typing.Optional[RemoveMembersRequest] = None,
        opt_pretty: typing.Optional[bool] = None,
        ...
        return self._remove_members_from_portfolio_oapg(
            body=args.body,
            query_params=args.query,
            path_params=args.path,
        )

class RemoveMembersFromPortfolio(BaseApi):
    ...
    async def aremove_members_from_portfolio(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PortfoliosRemoveMembersFromPortfolioResponsePydantic:
        raw_response = await self.raw.aremove_members_from_portfolio(
            portfolio_gid=portfolio_gid,
            data=data,
            opt_pretty=opt_pretty,
            opt_fields=opt_fields,
        ...
        if validate:
            return PortfoliosRemoveMembersFromPortfolioResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(PortfoliosRemoveMembersFromPortfolioResponsePydantic, raw_response.body)
    ...
    def remove_members_from_portfolio(
        ...
        raw_response = self.raw.remove_members_from_portfolio(
            portfolio_gid=portfolio_gid,
            data=data,
            opt_pretty=opt_pretty,
            opt_fields=opt_fields,
