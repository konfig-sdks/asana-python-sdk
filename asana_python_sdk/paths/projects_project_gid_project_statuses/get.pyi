...
from asana_python_sdk.model.project_statuses_get_project_updates_response import ProjectStatusesGetProjectUpdatesResponse as ProjectStatusesGetProjectUpdatesResponseSchema
from asana_python_sdk.model.error_response import ErrorResponse as ErrorResponseSchema

from asana_python_sdk.type.project_statuses_get_project_updates_response import ProjectStatusesGetProjectUpdatesResponse
from asana_python_sdk.type.error_response import ErrorResponse

from ...api_client import Dictionary
from asana_python_sdk.pydantic.project_statuses_get_project_updates_response import ProjectStatusesGetProjectUpdatesResponse as ProjectStatusesGetProjectUpdatesResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = ProjectStatusesGetProjectUpdatesResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ProjectStatusesGetProjectUpdatesResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_project_updates_mapped_args(
        self,
        project_gid: str,
    ...
    async def _aget_project_updates_oapg(
        self,
...
class GetProjectUpdatesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_project_updates(
        self,
        project_gid: str,
        opt_pretty: typing.Optional[bool] = None,
        limit: typing.Optional[int] = None,
        ...
        **kwargs,
        ...
        args = self._get_project_updates_mapped_args(
        ...
        return await self._aget_project_updates_oapg(
    ...
    def get_project_updates(
        ...
        return self._get_project_updates_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetProjectUpdates(BaseApi):
    ...
    async def aget_project_updates(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ProjectStatusesGetProjectUpdatesResponsePydantic:
        raw_response = await self.raw.aget_project_updates(
            project_gid=project_gid,
            opt_pretty=opt_pretty,
            limit=limit,
            offset=offset,
        ...
        if validate:
            return ProjectStatusesGetProjectUpdatesResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(ProjectStatusesGetProjectUpdatesResponsePydantic, raw_response.body)
    ...
    def get_project_updates(
        ...
        raw_response = self.raw.get_project_updates(
            project_gid=project_gid,
            opt_pretty=opt_pretty,
            limit=limit,
            offset=offset,
