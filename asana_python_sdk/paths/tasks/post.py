...
from asana_python_sdk.model.tasks_create_new_task_response import TasksCreateNewTaskResponse as TasksCreateNewTaskResponseSchema
from asana_python_sdk.model.task_request import TaskRequest as TaskRequestSchema
from asana_python_sdk.model.tasks_create_new_task_request import TasksCreateNewTaskRequest as TasksCreateNewTaskRequestSchema
from asana_python_sdk.model.error_response import ErrorResponse as ErrorResponseSchema

from asana_python_sdk.type.tasks_create_new_task_response import TasksCreateNewTaskResponse
from asana_python_sdk.type.tasks_create_new_task_request import TasksCreateNewTaskRequest
...
from asana_python_sdk.pydantic.tasks_create_new_task_request import TasksCreateNewTaskRequest as TasksCreateNewTaskRequestPydantic
...
from asana_python_sdk.pydantic.tasks_create_new_task_response import TasksCreateNewTaskResponse as TasksCreateNewTaskResponsePydantic
...
# body param
SchemaForRequestBodyApplicationJson = TasksCreateNewTaskRequestSchema


request_body_tasks_create_new_task_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = TasksCreateNewTaskResponseSchema


@dataclass
class ApiResponseFor201(api_client.ApiResponse):
    body: TasksCreateNewTaskResponse
...
class BaseApi(api_client.Api):
    ...
    async def _acreate_new_task_oapg(
        ...
        **kwargs,
        ...
        serialized_data = request_body_tasks_create_new_task_request.serialize(body, content_type)
...
class CreateNewTask(BaseApi):
    ...
    async def acreate_new_task(
        ...
        validate: bool = False,
        **kwargs,
    ) -> TasksCreateNewTaskResponsePydantic:
        ...
        if validate:
            return TasksCreateNewTaskResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(TasksCreateNewTaskResponsePydantic, raw_response.body)
