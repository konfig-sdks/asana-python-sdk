...
from asana_python_sdk.model.webhooks_list_multiple_webhooks_response import WebhooksListMultipleWebhooksResponse as WebhooksListMultipleWebhooksResponseSchema
from asana_python_sdk.model.error_response import ErrorResponse as ErrorResponseSchema

from asana_python_sdk.type.webhooks_list_multiple_webhooks_response import WebhooksListMultipleWebhooksResponse
...
from asana_python_sdk.pydantic.webhooks_list_multiple_webhooks_response import WebhooksListMultipleWebhooksResponse as WebhooksListMultipleWebhooksResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = WebhooksListMultipleWebhooksResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: WebhooksListMultipleWebhooksResponse
...
class BaseApi(api_client.Api):
    ...
    def _list_multiple_webhooks_mapped_args(
        self,
        workspace: str,
    ...
    async def _alist_multiple_webhooks_oapg(
        self,
    ...
    def _list_multiple_webhooks_oapg(
        self,
            query_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class ListMultipleWebhooksRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_multiple_webhooks(
        self,
        workspace: str,
        opt_pretty: typing.Optional[bool] = None,
        limit: typing.Optional[int] = None,
        ...
        **kwargs,
        ...
        args = self._list_multiple_webhooks_mapped_args(
            workspace=workspace,
        ...
        return await self._alist_multiple_webhooks_oapg(
            query_params=args.query,
            **kwargs,
        )
    
    def list_multiple_webhooks(
        self,
        workspace: str,
        opt_pretty: typing.Optional[bool] = None,
        limit: typing.Optional[int] = None,
        ...
        return self._list_multiple_webhooks_oapg(
            query_params=args.query,
        )

class ListMultipleWebhooks(BaseApi):
    ...
    async def alist_multiple_webhooks(
        ...
        validate: bool = False,
        **kwargs,
    ) -> WebhooksListMultipleWebhooksResponsePydantic:
        raw_response = await self.raw.alist_multiple_webhooks(
            workspace=workspace,
            opt_pretty=opt_pretty,
            limit=limit,
            offset=offset,
        ...
        if validate:
            return WebhooksListMultipleWebhooksResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(WebhooksListMultipleWebhooksResponsePydantic, raw_response.body)
    ...
    def list_multiple_webhooks(
        ...
        raw_response = self.raw.list_multiple_webhooks(
            workspace=workspace,
            opt_pretty=opt_pretty,
            limit=limit,
            offset=offset,
