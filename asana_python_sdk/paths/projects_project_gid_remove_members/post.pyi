...
from asana_python_sdk.model.projects_remove_members_from_project_response import ProjectsRemoveMembersFromProjectResponse as ProjectsRemoveMembersFromProjectResponseSchema
from asana_python_sdk.model.remove_members_request import RemoveMembersRequest as RemoveMembersRequestSchema
from asana_python_sdk.model.projects_remove_members_from_project_request import ProjectsRemoveMembersFromProjectRequest as ProjectsRemoveMembersFromProjectRequestSchema
...
from asana_python_sdk.type.projects_remove_members_from_project_request import ProjectsRemoveMembersFromProjectRequest
from asana_python_sdk.type.error_response import ErrorResponse
from asana_python_sdk.type.projects_remove_members_from_project_response import ProjectsRemoveMembersFromProjectResponse
...
from asana_python_sdk.pydantic.projects_remove_members_from_project_response import ProjectsRemoveMembersFromProjectResponse as ProjectsRemoveMembersFromProjectResponsePydantic
from asana_python_sdk.pydantic.projects_remove_members_from_project_request import ProjectsRemoveMembersFromProjectRequest as ProjectsRemoveMembersFromProjectRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = ProjectsRemoveMembersFromProjectRequestSchema


request_body_projects_remove_members_from_project_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ProjectsRemoveMembersFromProjectResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ProjectsRemoveMembersFromProjectResponse
...
class BaseApi(api_client.Api):
    ...
    def _remove_members_from_project_mapped_args(
        self,
        project_gid: str,
    ...
    async def _aremove_members_from_project_oapg(
        self,
        ...
        **kwargs,
        ...
        serialized_data = request_body_projects_remove_members_from_project_request.serialize(body, content_type)
    ...
    def _remove_members_from_project_oapg(
        self,
        body: typing.Any = None,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
...
class RemoveMembersFromProjectRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aremove_members_from_project(
        self,
        project_gid: str,
        data: typing.Optional[RemoveMembersRequest] = None,
        opt_pretty: typing.Optional[bool] = None,
        ...
        **kwargs,
        ...
        args = self._remove_members_from_project_mapped_args(
            project_gid=project_gid,
            data=data,
            opt_pretty=opt_pretty,
            opt_fields=opt_fields,
        )
        return await self._aremove_members_from_project_oapg(
            body=args.body,
    ...
    def remove_members_from_project(
        ...
        return self._remove_members_from_project_oapg(
            body=args.body,
            query_params=args.query,
            path_params=args.path,
        )

class RemoveMembersFromProject(BaseApi):
    ...
    async def aremove_members_from_project(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ProjectsRemoveMembersFromProjectResponsePydantic:
        raw_response = await self.raw.aremove_members_from_project(
            project_gid=project_gid,
            data=data,
            opt_pretty=opt_pretty,
            opt_fields=opt_fields,
        ...
        if validate:
            return ProjectsRemoveMembersFromProjectResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(ProjectsRemoveMembersFromProjectResponsePydantic, raw_response.body)
    ...
    def remove_members_from_project(
        ...
        raw_response = self.raw.remove_members_from_project(
            project_gid=project_gid,
            data=data,
            opt_pretty=opt_pretty,
            opt_fields=opt_fields,
