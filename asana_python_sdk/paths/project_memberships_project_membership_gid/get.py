...
from asana_python_sdk.model.project_memberships_get_record_response import ProjectMembershipsGetRecordResponse as ProjectMembershipsGetRecordResponseSchema
from asana_python_sdk.model.error_response import ErrorResponse as ErrorResponseSchema

from asana_python_sdk.type.project_memberships_get_record_response import ProjectMembershipsGetRecordResponse
...
from asana_python_sdk.pydantic.project_memberships_get_record_response import ProjectMembershipsGetRecordResponse as ProjectMembershipsGetRecordResponsePydantic
...
class OptFieldsSchema(
    ...
    class MetaOapg:
        ...
        class items(
            ...
            @schemas.classproperty
            def WRITE_ACCESS(cls):
                return cls("write_access")
...
SchemaFor200ResponseBodyApplicationJson = ProjectMembershipsGetRecordResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ProjectMembershipsGetRecordResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_record_mapped_args(
        ...
        if project_membership_gid is not None:
            _path_params["project_membership_gid"] = project_membership_gid
...
class GetRecord(BaseApi):
    ...
    async def aget_record(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ProjectMembershipsGetRecordResponsePydantic:
        ...
        if validate:
            return ProjectMembershipsGetRecordResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(ProjectMembershipsGetRecordResponsePydantic, raw_response.body)
