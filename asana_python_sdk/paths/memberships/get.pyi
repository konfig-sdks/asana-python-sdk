...
from asana_python_sdk.model.memberships_get_multiple_response import MembershipsGetMultipleResponse as MembershipsGetMultipleResponseSchema
from asana_python_sdk.model.error_response import ErrorResponse as ErrorResponseSchema

from asana_python_sdk.type.memberships_get_multiple_response import MembershipsGetMultipleResponse
...
from asana_python_sdk.pydantic.memberships_get_multiple_response import MembershipsGetMultipleResponse as MembershipsGetMultipleResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = MembershipsGetMultipleResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: MembershipsGetMultipleResponse
...
class GetMultiple(BaseApi):
    ...
    async def aget_multiple(
        ...
        validate: bool = False,
        **kwargs,
    ) -> MembershipsGetMultipleResponsePydantic:
        ...
        if validate:
            return MembershipsGetMultipleResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(MembershipsGetMultipleResponsePydantic, raw_response.body)
