...
from asana_python_sdk.model.portfolios_get_items_response import PortfoliosGetItemsResponse as PortfoliosGetItemsResponseSchema
...
from asana_python_sdk.type.portfolios_get_items_response import PortfoliosGetItemsResponse

from ...api_client import Dictionary
from asana_python_sdk.pydantic.portfolios_get_items_response import PortfoliosGetItemsResponse as PortfoliosGetItemsResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = PortfoliosGetItemsResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: PortfoliosGetItemsResponse
...
class GetItemsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_items(
        self,
        portfolio_gid: str,
        opt_pretty: typing.Optional[bool] = None,
        limit: typing.Optional[int] = None,
        ...
        **kwargs,
        ...
        args = self._get_items_mapped_args(
        ...
        return await self._aget_items_oapg(
    ...
    def get_items(
        ...
        return self._get_items_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetItems(BaseApi):
    ...
    async def aget_items(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PortfoliosGetItemsResponsePydantic:
        raw_response = await self.raw.aget_items(
            portfolio_gid=portfolio_gid,
            opt_pretty=opt_pretty,
            limit=limit,
            offset=offset,
        ...
        if validate:
            return PortfoliosGetItemsResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(PortfoliosGetItemsResponsePydantic, raw_response.body)
    ...
    def get_items(
        ...
        raw_response = self.raw.get_items(
            portfolio_gid=portfolio_gid,
            opt_pretty=opt_pretty,
            limit=limit,
            offset=offset,
