...
from asana_python_sdk.model.status_updates_get_record_by_id_response import StatusUpdatesGetRecordByIdResponse as StatusUpdatesGetRecordByIdResponseSchema
from asana_python_sdk.model.error_response import ErrorResponse as ErrorResponseSchema

from asana_python_sdk.type.status_updates_get_record_by_id_response import StatusUpdatesGetRecordByIdResponse
...
from asana_python_sdk.pydantic.status_updates_get_record_by_id_response import StatusUpdatesGetRecordByIdResponse as StatusUpdatesGetRecordByIdResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = StatusUpdatesGetRecordByIdResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: StatusUpdatesGetRecordByIdResponse
...
class GetRecordById(BaseApi):
    ...
    async def aget_record_by_id(
        ...
        validate: bool = False,
        **kwargs,
    ) -> StatusUpdatesGetRecordByIdResponsePydantic:
        ...
        if validate:
            return StatusUpdatesGetRecordByIdResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(StatusUpdatesGetRecordByIdResponsePydantic, raw_response.body)
