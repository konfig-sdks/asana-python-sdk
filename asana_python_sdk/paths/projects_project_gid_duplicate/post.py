...
from asana_python_sdk.model.project_duplicate_request import ProjectDuplicateRequest as ProjectDuplicateRequestSchema
from asana_python_sdk.model.projects_duplicate_project_job_request import ProjectsDuplicateProjectJobRequest as ProjectsDuplicateProjectJobRequestSchema
from asana_python_sdk.model.projects_duplicate_project_job_response import ProjectsDuplicateProjectJobResponse as ProjectsDuplicateProjectJobResponseSchema
from asana_python_sdk.model.error_response import ErrorResponse as ErrorResponseSchema

from asana_python_sdk.type.projects_duplicate_project_job_request import ProjectsDuplicateProjectJobRequest
from asana_python_sdk.type.projects_duplicate_project_job_response import ProjectsDuplicateProjectJobResponse
from asana_python_sdk.type.error_response import ErrorResponse
from asana_python_sdk.type.project_duplicate_request import ProjectDuplicateRequest

from ...api_client import Dictionary
from asana_python_sdk.pydantic.projects_duplicate_project_job_request import ProjectsDuplicateProjectJobRequest as ProjectsDuplicateProjectJobRequestPydantic
from asana_python_sdk.pydantic.error_response import ErrorResponse as ErrorResponsePydantic
from asana_python_sdk.pydantic.projects_duplicate_project_job_response import ProjectsDuplicateProjectJobResponse as ProjectsDuplicateProjectJobResponsePydantic
from asana_python_sdk.pydantic.project_duplicate_request import ProjectDuplicateRequest as ProjectDuplicateRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = ProjectsDuplicateProjectJobRequestSchema


request_body_projects_duplicate_project_job_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = ProjectsDuplicateProjectJobResponseSchema


@dataclass
class ApiResponseFor201(api_client.ApiResponse):
    body: ProjectsDuplicateProjectJobResponse
...
class BaseApi(api_client.Api):
    ...
    def _duplicate_project_job_mapped_args(
        self,
        project_gid: str,
        data: typing.Optional[ProjectDuplicateRequest] = None,
    ...
    async def _aduplicate_project_job_oapg(
        self,
        ...
        **kwargs,
        ...
        if body is not schemas.unset:
            serialized_data = request_body_projects_duplicate_project_job_request.serialize(body, content_type)
    ...
    def _duplicate_project_job_oapg(
        self,
        body: typing.Any = None,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
...
class DuplicateProjectJobRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aduplicate_project_job(
        self,
        project_gid: str,
        data: typing.Optional[ProjectDuplicateRequest] = None,
        opt_pretty: typing.Optional[bool] = None,
        ...
        **kwargs,
        ...
        args = self._duplicate_project_job_mapped_args(
            project_gid=project_gid,
            data=data,
            opt_pretty=opt_pretty,
            opt_fields=opt_fields,
        )
        return await self._aduplicate_project_job_oapg(
            body=args.body,
    ...
    def duplicate_project_job(
        ...
        return self._duplicate_project_job_oapg(
            body=args.body,
            query_params=args.query,
            path_params=args.path,
        )

class DuplicateProjectJob(BaseApi):
    ...
    async def aduplicate_project_job(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ProjectsDuplicateProjectJobResponsePydantic:
        raw_response = await self.raw.aduplicate_project_job(
            project_gid=project_gid,
            data=data,
            opt_pretty=opt_pretty,
            opt_fields=opt_fields,
        ...
        if validate:
            return ProjectsDuplicateProjectJobResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(ProjectsDuplicateProjectJobResponsePydantic, raw_response.body)
    ...
    def duplicate_project_job(
        ...
        raw_response = self.raw.duplicate_project_job(
            project_gid=project_gid,
            data=data,
            opt_pretty=opt_pretty,
            opt_fields=opt_fields,
