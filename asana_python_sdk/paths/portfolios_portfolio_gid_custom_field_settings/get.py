...
from asana_python_sdk.model.custom_field_settings_get_portfolio_custom_field_settings_response import CustomFieldSettingsGetPortfolioCustomFieldSettingsResponse as CustomFieldSettingsGetPortfolioCustomFieldSettingsResponseSchema
from asana_python_sdk.model.error_response import ErrorResponse as ErrorResponseSchema

from asana_python_sdk.type.custom_field_settings_get_portfolio_custom_field_settings_response import CustomFieldSettingsGetPortfolioCustomFieldSettingsResponse
...
from asana_python_sdk.pydantic.custom_field_settings_get_portfolio_custom_field_settings_response import CustomFieldSettingsGetPortfolioCustomFieldSettingsResponse as CustomFieldSettingsGetPortfolioCustomFieldSettingsResponsePydantic
        ...
        class items(
            ...
            class MetaOapg:
                enum_value_to_name = {
                    ...
                    "custom_field.asana_created_field": "CUSTOM_FIELD_ASANA_CREATED_FIELD",
                    "custom_field.created_by": "CUSTOM_FIELD_CREATED_BY",
                    "custom_field.created_by.name": "CUSTOM_FIELD_CREATED_BY_NAME",
                    "custom_field.currency_code": "CUSTOM_FIELD_CURRENCY_CODE",
                    "custom_field.custom_label": "CUSTOM_FIELD_CUSTOM_LABEL",
                    "custom_field.custom_label_position": "CUSTOM_FIELD_CUSTOM_LABEL_POSITION",
                    ...
                    "custom_field.description": "CUSTOM_FIELD_DESCRIPTION",
                    ...
                    "custom_field.format": "CUSTOM_FIELD_FORMAT",
                    "custom_field.has_notifications_enabled": "CUSTOM_FIELD_HAS_NOTIFICATIONS_ENABLED",
                    "custom_field.id_prefix": "CUSTOM_FIELD_ID_PREFIX",
                    "custom_field.is_formula_field": "CUSTOM_FIELD_IS_FORMULA_FIELD",
                    "custom_field.is_global_to_workspace": "CUSTOM_FIELD_IS_GLOBAL_TO_WORKSPACE",
                    "custom_field.is_value_read_only": "CUSTOM_FIELD_IS_VALUE_READ_ONLY",
                    ...
                    "custom_field.people_value": "CUSTOM_FIELD_PEOPLE_VALUE",
                    "custom_field.people_value.name": "CUSTOM_FIELD_PEOPLE_VALUE_NAME",
                    "custom_field.precision": "CUSTOM_FIELD_PRECISION",
...
SchemaFor200ResponseBodyApplicationJson = CustomFieldSettingsGetPortfolioCustomFieldSettingsResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: CustomFieldSettingsGetPortfolioCustomFieldSettingsResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_portfolio_custom_field_settings_mapped_args(
        self,
        portfolio_gid: str,
    ...
    async def _aget_portfolio_custom_field_settings_oapg(
        self,
    ...
    def _get_portfolio_custom_field_settings_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetPortfolioCustomFieldSettingsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_portfolio_custom_field_settings(
        self,
        portfolio_gid: str,
        opt_pretty: typing.Optional[bool] = None,
        limit: typing.Optional[int] = None,
        ...
        **kwargs,
        ...
        args = self._get_portfolio_custom_field_settings_mapped_args(
        ...
        return await self._aget_portfolio_custom_field_settings_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def get_portfolio_custom_field_settings(
        self,
        portfolio_gid: str,
        opt_pretty: typing.Optional[bool] = None,
        limit: typing.Optional[int] = None,
        ...
        return self._get_portfolio_custom_field_settings_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetPortfolioCustomFieldSettings(BaseApi):
    ...
    async def aget_portfolio_custom_field_settings(
        ...
        validate: bool = False,
        **kwargs,
    ) -> CustomFieldSettingsGetPortfolioCustomFieldSettingsResponsePydantic:
        raw_response = await self.raw.aget_portfolio_custom_field_settings(
            portfolio_gid=portfolio_gid,
            opt_pretty=opt_pretty,
            limit=limit,
            offset=offset,
        ...
        if validate:
            return CustomFieldSettingsGetPortfolioCustomFieldSettingsResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(CustomFieldSettingsGetPortfolioCustomFieldSettingsResponsePydantic, raw_response.body)
    ...
    def get_portfolio_custom_field_settings(
        ...
        raw_response = self.raw.get_portfolio_custom_field_settings(
            portfolio_gid=portfolio_gid,
            opt_pretty=opt_pretty,
            limit=limit,
            offset=offset,
