...
from asana_python_sdk.model.tasks_get_multiple_with_tag_response import TasksGetMultipleWithTagResponse as TasksGetMultipleWithTagResponseSchema
from asana_python_sdk.model.error_response import ErrorResponse as ErrorResponseSchema

from asana_python_sdk.type.tasks_get_multiple_with_tag_response import TasksGetMultipleWithTagResponse
from asana_python_sdk.type.error_response import ErrorResponse

from ...api_client import Dictionary
from asana_python_sdk.pydantic.tasks_get_multiple_with_tag_response import TasksGetMultipleWithTagResponse as TasksGetMultipleWithTagResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = TasksGetMultipleWithTagResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: TasksGetMultipleWithTagResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_multiple_with_tag_mapped_args(
        self,
        tag_gid: str,
    ...
    async def _aget_multiple_with_tag_oapg(
        self,
    ...
    def _get_multiple_with_tag_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetMultipleWithTagRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_multiple_with_tag(
        self,
        tag_gid: str,
        opt_pretty: typing.Optional[bool] = None,
        limit: typing.Optional[int] = None,
        ...
        **kwargs,
        ...
        args = self._get_multiple_with_tag_mapped_args(
            tag_gid=tag_gid,
        ...
        return await self._aget_multiple_with_tag_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def get_multiple_with_tag(
        self,
        tag_gid: str,
        opt_pretty: typing.Optional[bool] = None,
        limit: typing.Optional[int] = None,
        ...
        return self._get_multiple_with_tag_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetMultipleWithTag(BaseApi):
    ...
    async def aget_multiple_with_tag(
        ...
        validate: bool = False,
        **kwargs,
    ) -> TasksGetMultipleWithTagResponsePydantic:
        raw_response = await self.raw.aget_multiple_with_tag(
            tag_gid=tag_gid,
            opt_pretty=opt_pretty,
            limit=limit,
            offset=offset,
        ...
        if validate:
            return TasksGetMultipleWithTagResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(TasksGetMultipleWithTagResponsePydantic, raw_response.body)
    ...
    def get_multiple_with_tag(
        ...
        raw_response = self.raw.get_multiple_with_tag(
            tag_gid=tag_gid,
            opt_pretty=opt_pretty,
            limit=limit,
            offset=offset,
