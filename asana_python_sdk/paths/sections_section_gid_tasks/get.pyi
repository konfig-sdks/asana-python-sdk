...
from asana_python_sdk.model.tasks_get_section_tasks_response import TasksGetSectionTasksResponse as TasksGetSectionTasksResponseSchema
from asana_python_sdk.model.error_response import ErrorResponse as ErrorResponseSchema

from asana_python_sdk.type.tasks_get_section_tasks_response import TasksGetSectionTasksResponse
...
from asana_python_sdk.pydantic.tasks_get_section_tasks_response import TasksGetSectionTasksResponse as TasksGetSectionTasksResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = TasksGetSectionTasksResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: TasksGetSectionTasksResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_section_tasks_mapped_args(
        self,
        section_gid: str,
    ...
    async def _aget_section_tasks_oapg(
        self,
...
class GetSectionTasksRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_section_tasks(
        self,
        section_gid: str,
        opt_pretty: typing.Optional[bool] = None,
        limit: typing.Optional[int] = None,
        ...
        **kwargs,
        ...
        args = self._get_section_tasks_mapped_args(
        ...
        return await self._aget_section_tasks_oapg(
    ...
    def get_section_tasks(
        ...
        return self._get_section_tasks_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetSectionTasks(BaseApi):
    ...
    async def aget_section_tasks(
        ...
        validate: bool = False,
        **kwargs,
    ) -> TasksGetSectionTasksResponsePydantic:
        raw_response = await self.raw.aget_section_tasks(
            section_gid=section_gid,
            opt_pretty=opt_pretty,
            limit=limit,
            offset=offset,
        ...
        if validate:
            return TasksGetSectionTasksResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(TasksGetSectionTasksResponsePydantic, raw_response.body)
    ...
    def get_section_tasks(
        ...
        raw_response = self.raw.get_section_tasks(
            section_gid=section_gid,
            opt_pretty=opt_pretty,
            limit=limit,
            offset=offset,
