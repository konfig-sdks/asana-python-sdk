...
from asana_python_sdk.model.team_memberships_get_compact_response import TeamMembershipsGetCompactResponse as TeamMembershipsGetCompactResponseSchema
from asana_python_sdk.model.error_response import ErrorResponse as ErrorResponseSchema

from asana_python_sdk.type.team_memberships_get_compact_response import TeamMembershipsGetCompactResponse
...
from asana_python_sdk.pydantic.team_memberships_get_compact_response import TeamMembershipsGetCompactResponse as TeamMembershipsGetCompactResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = TeamMembershipsGetCompactResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: TeamMembershipsGetCompactResponse
...
class GetCompact(BaseApi):
    ...
    async def aget_compact(
        ...
        validate: bool = False,
        **kwargs,
    ) -> TeamMembershipsGetCompactResponsePydantic:
        ...
        if validate:
            return TeamMembershipsGetCompactResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(TeamMembershipsGetCompactResponsePydantic, raw_response.body)
