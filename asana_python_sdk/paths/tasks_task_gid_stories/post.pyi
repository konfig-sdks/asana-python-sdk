...
from asana_python_sdk.model.stories_create_comment_request import StoriesCreateCommentRequest as StoriesCreateCommentRequestSchema
from asana_python_sdk.model.stories_create_comment_response import StoriesCreateCommentResponse as StoriesCreateCommentResponseSchema
...
from asana_python_sdk.type.stories_create_comment_response import StoriesCreateCommentResponse
from asana_python_sdk.type.stories_create_comment_request import StoriesCreateCommentRequest
...
from asana_python_sdk.pydantic.stories_create_comment_request import StoriesCreateCommentRequest as StoriesCreateCommentRequestPydantic
...
from asana_python_sdk.pydantic.stories_create_comment_response import StoriesCreateCommentResponse as StoriesCreateCommentResponsePydantic
...
# body param
SchemaForRequestBodyApplicationJson = StoriesCreateCommentRequestSchema


request_body_stories_create_comment_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = StoriesCreateCommentResponseSchema


@dataclass
class ApiResponseFor201(api_client.ApiResponse):
    body: StoriesCreateCommentResponse
...
class BaseApi(api_client.Api):
    ...
    async def _acreate_comment_oapg(
        ...
        **kwargs,
        ...
        serialized_data = request_body_stories_create_comment_request.serialize(body, content_type)
...
class CreateComment(BaseApi):
    ...
    async def acreate_comment(
        ...
        validate: bool = False,
        **kwargs,
    ) -> StoriesCreateCommentResponsePydantic:
        ...
        if validate:
            return StoriesCreateCommentResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(StoriesCreateCommentResponsePydantic, raw_response.body)
