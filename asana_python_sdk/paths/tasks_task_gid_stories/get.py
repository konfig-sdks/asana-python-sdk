...
from asana_python_sdk.model.stories_get_task_stories_response import StoriesGetTaskStoriesResponse as StoriesGetTaskStoriesResponseSchema
from asana_python_sdk.model.error_response import ErrorResponse as ErrorResponseSchema

from asana_python_sdk.type.stories_get_task_stories_response import StoriesGetTaskStoriesResponse
from asana_python_sdk.type.error_response import ErrorResponse

from ...api_client import Dictionary
from asana_python_sdk.pydantic.stories_get_task_stories_response import StoriesGetTaskStoriesResponse as StoriesGetTaskStoriesResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = StoriesGetTaskStoriesResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: StoriesGetTaskStoriesResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_task_stories_mapped_args(
        self,
        task_gid: str,
    ...
    async def _aget_task_stories_oapg(
        self,
...
class GetTaskStoriesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_task_stories(
        self,
        task_gid: str,
        opt_pretty: typing.Optional[bool] = None,
        limit: typing.Optional[int] = None,
        ...
        **kwargs,
        ...
        args = self._get_task_stories_mapped_args(
            task_gid=task_gid,
        ...
        return await self._aget_task_stories_oapg(
    ...
    def get_task_stories(
        ...
        return self._get_task_stories_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetTaskStories(BaseApi):
    ...
    async def aget_task_stories(
        ...
        validate: bool = False,
        **kwargs,
    ) -> StoriesGetTaskStoriesResponsePydantic:
        raw_response = await self.raw.aget_task_stories(
            task_gid=task_gid,
            opt_pretty=opt_pretty,
            limit=limit,
            offset=offset,
        ...
        if validate:
            return StoriesGetTaskStoriesResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(StoriesGetTaskStoriesResponsePydantic, raw_response.body)
    ...
    def get_task_stories(
        ...
        raw_response = self.raw.get_task_stories(
            task_gid=task_gid,
            opt_pretty=opt_pretty,
            limit=limit,
            offset=offset,
