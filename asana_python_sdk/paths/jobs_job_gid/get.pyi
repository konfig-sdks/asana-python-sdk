...
from asana_python_sdk.model.jobs_get_by_id_response import JobsGetByIdResponse as JobsGetByIdResponseSchema
...
from asana_python_sdk.type.jobs_get_by_id_response import JobsGetByIdResponse

from ...api_client import Dictionary
from asana_python_sdk.pydantic.error_response import ErrorResponse as ErrorResponsePydantic
from asana_python_sdk.pydantic.jobs_get_by_id_response import JobsGetByIdResponse as JobsGetByIdResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = JobsGetByIdResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: JobsGetByIdResponse
...
class GetById(BaseApi):
    ...
    async def aget_by_id(
        ...
        **kwargs,
        ...
        if validate:
            return JobsGetByIdResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(JobsGetByIdResponsePydantic, raw_response.body)
