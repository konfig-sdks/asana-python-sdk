...
class CustomFieldSettingsGetPortfolioCustomFieldSettingsResponse(BaseModel):
    data: typing.Optional[typing.List[CustomFieldSettingResponse]] = Field(None, alias='data')
